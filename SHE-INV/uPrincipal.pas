...
begin
  ...
  try
    ...
    SLPrincipal.Values['fin_pag']         := oREPZero('fin_pag'        ,'_',RECParametros.EP_ID,3);
    SLPrincipal.Values['fin_pag_rec']     := oREPZero('fin_pag_rec'    ,'_',RECParametros.EP_ID,3);
    SLPrincipal.Values['fin_pag_bai']     := oREPZero('fin_pag_bai'    ,'_',RECParametros.EP_ID,3);
    SLPrincipal.Values['fin_pag_coc']     := oREPZero('fin_pag_coc'    ,'_',RECParametros.EP_ID,3);
    SLPrincipal.Values['fin_pag_coi']     := oREPZero('fin_pag_coi'    ,'_',RECParametros.EP_ID,3);
    SLPrincipal.Values['fin_pag_dup']     := oREPZero('fin_pag_dup'    ,'_',RECParametros.EP_ID,3);
    SLPrincipal.Values['fin_pag_obs']     := oREPZero('fin_pag_obs'    ,'_',RECParametros.EP_ID,3);
    SLPrincipal.Values['fin_rec']         := oREPZero('fin_rec'        ,'_',RECParametros.EP_ID,3);
    SLPrincipal.Values['fin_rec_dup']     := oREPZero('fin_rec_dup'    ,'_',RECParametros.EP_ID,3);
    SLPrincipal.Values['fin_rec_obs']     := oREPZero('fin_rec_obs'    ,'_',RECParametros.EP_ID,3);
    ...
    SLPrincipal.Values['ped_avi_cab']     := oREPZero('ped_avi_cab'    ,'_',RECParametros.EP_ID,3);
    SLPrincipal.Values['ped_avi_ite']     := oREPZero('ped_avi_ite'    ,'_',RECParametros.EP_ID,3);
    SLPrincipal.Values['ped_oca_cab']     := oREPZero('ped_oca_cab'    ,'_',RECParametros.EP_ID,3);
    SLPrincipal.Values['ped_oca_ite']     := oREPZero('ped_oca_ite'    ,'_',RECParametros.EP_ID,3);
    ...
    SLPrincipal.Values['ped_tec_cab']     := oREPZero('ped_tec_cab'    ,'_',RECParametros.EP_ID,3);
    SLPrincipal.Values['ped_tec_ite']     := oREPZero('ped_tec_ite'    ,'_',RECParametros.EP_ID,3);
    ...
    SLPrincipal.Values['rom_des']         := oREPZero('rom_des'        ,'_',RECParametros.EP_ID,3);
    SLPrincipal.Values['tab_alq']         := oREPZero('tab_alq'        ,'_',RECParametros.EP_ID,3);
    SLPrincipal.Values['tab_ban']         := oREPZero('tab_ban'        ,'_',RECParametros.EP_ID,3);
