...
procedure TFrmSHE_DEF_PSQ._WM_AFTER_ACTIVATE(var Msg: TMessage);
begin
  oUnLockWindowUpdate; { Desbloqueia Tela }
end;

procedure TFrmSHE_DEF_PSQ.SetCurrentEvent(const AValue: String);
begin
  FCurrentEvent := AValue;
end;

procedure TFrmSHE_DEF_PSQ.SetForceClose(const AValue: Boolean);
begin
  FForceClose := AValue;
end;
