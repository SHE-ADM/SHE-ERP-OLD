...
begin
  RECDefault.Event  := oREPZero('CAD_PRO','_',RECParametros.Id,3);
  RECDefault.GEN_ID := 'IDG_TAB_SEG';

  RECDefault.Tabela := 'TAB_SCT';
  RECDefault.Funcao := 'Tabelas';
  RECDefault.Rotina := 'Segmentos';
  RECDefault.Nome   := 'Permissões Gerais';
  inherited;
end;
...
begin
  ...
  EdicaoDEEP.Value := RECparametros.FANTASIA;
