...
begin
  ...
  ibSP.ParamByName('dcad').Value := RECParametros.DTServidor;
  ibSP.ParamByName('dalt').Value := RECParametros.DTServidor;
  ibSP.ParamByName('dfun').Value := RECParametros.DTServidor;
