...
procedure TFrmCFeSat.RSBCupomClick(Sender: TObject);
          ...
          var
            ...
            ARQTxt2: PAnsiChar;
          begin
            ARQTxt  := PAnsiChar(RECParametros.PathCupomFiscal+'Txt\'+EDNumero.Text+'.txt');
            ARQTxt2 := PAnsiChar(RECParametros.PathCupomFiscal+'Envia\'+EDNumero.Text+'.txt');
            try
              ...
              WriteLN(TFTxt,'signAC_B12='+Trim(RECParametros.SwHAssinatura));
