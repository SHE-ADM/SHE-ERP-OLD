...
begin
  ...
  FormatDateTime('yyyy-mm-dd',Date)+'T'+FormatDatetime('hh:mm:ss',Now)+'-03:00', //Data e hora do evento no formato AAAA-MMDDThh:mm:ssTZD
...
begin
  ...
  try
    if oBSONumero(edcdnf.Hint) then
    with consulta do
    begin
      SQL.Clear;
    ...
    frmemail.edtitulo.Text := FrmPrincipal.parametrosPAR_FANT.AsString+' - CCe.: '+edcdnf.Text;
