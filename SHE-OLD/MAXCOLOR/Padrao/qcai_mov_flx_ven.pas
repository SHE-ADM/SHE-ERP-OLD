...
type
  Tqrpcai_mov_flx_ven = class(TQuickRep)
    QRBand1: TQRBand;
    QRLabel50: TQRLabel;
    QRLabel51: TQRLabel;
    qrilogo: TQRImage;
...
var
  qrpcai_mov_flx_ven: Tqrpcai_mov_flx_ven;
...
procedure Tqrpcai_mov_flx_ven.carregaFoto(tam: Integer; valor: TBlobField; tab: TIbDataSet; par: TIbDataSet );
var
  BlobStream : TStream;
...
procedure Tqrpcai_mov_flx_ven.relatorioCalcFields(DataSet: TDataSet);
begin
