...
procedure Tqrpnfe_rep.carregaFoto(tam: Integer; valor: TBlobField; tab: TIbDataSet; par: TIbDataSet );
var
  BlobStream : TStream;
...
procedure Tqrpnfe_rep.QRBand9BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
