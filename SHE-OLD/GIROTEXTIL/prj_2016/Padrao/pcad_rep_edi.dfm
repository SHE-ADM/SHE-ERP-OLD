inherited frmcad_rep_edi: Tfrmcad_rep_edi
      ...
      object pcmain: TdxPageControl
        ...
        object tsBAN: TdxTabSheet
          ...
          object dbgban: TdxDBGrid
            ...
            object dbgbanREP_DCAD: TdxDBGridDateColumn
              BandIndex = 0
              RowIndex = 0
              FieldName = 'REP_DCAD'
            end
            object dbgbanREP_BANC: TdxDBGridMaskColumn
              Width = 41
              BandIndex = 0
              RowIndex = 0
              FieldName = 'REP_BANC'
            end
            object dbgbanREP_DESC: TdxDBGridPickColumn
              Width = 246
              BandIndex = 0
              RowIndex = 0
              FieldName = 'REP_DESC'
            end
            object dbgbanREP_AGEN: TdxDBGridMaskColumn
              Width = 52
              BandIndex = 0
              RowIndex = 0
              FieldName = 'REP_AGEN'
            end
            object dbgbanREP_CONT: TdxDBGridMaskColumn
              Width = 79
              BandIndex = 0
              RowIndex = 0
              FieldName = 'REP_CONT'
            end
            object dbgbanREP_TIPO: TdxDBGridPickColumn
              Width = 125
              BandIndex = 0
              RowIndex = 0
              FieldName = 'REP_TIPO'
            end
            object dbgbanREP_DOCU: TdxDBGridMaskColumn
              Width = 141
              BandIndex = 0
              RowIndex = 0
              FieldName = 'REP_DOCU'
            end
            object dbgbanREP_OBSE: TdxDBGridBlobColumn
              Width = 28
              BandIndex = 0
              RowIndex = 0
              FieldName = 'REP_OBSE'
  ...
  object cad_rep_ban: TIBDataSet
    Database = dmDADOS.ibDB
    Transaction = IBTra
    AfterCancel = cad_rep_banAfterCancel
    AfterDelete = cad_rep_banAfterDelete
    AfterEdit = cad_rep_banAfterEdit
    AfterInsert = cad_rep_banAfterEdit
    AfterPost = cad_rep_banAfterPost
    BeforeCancel = cad_rep_banBeforeCancel
    BeforeDelete = cad_rep_banBeforeDelete
    OnNewRecord = cad_rep_banNewRecord
    DeleteSQL.Strings = (
      'delete from CAD_REP_BAN'
      'where'
      '  ID = :OLD_ID')
    InsertSQL.Strings = (
      'insert into CAD_REP_BAN'
      
        '  (ID, REP_AGEN, REP_BANC, REP_CONT, REP_CREP, REP_DCAD, REP_DES' +
        'C, REP_DOCU, '
      '   REP_OBSE, REP_TIPO)'
      'values'
      
        '  (:ID, :REP_AGEN, :REP_BANC, :REP_CONT, :REP_CREP, :REP_DCAD, :' +
        'REP_DESC, '
      '   :REP_DOCU, :REP_OBSE, :REP_TIPO)')
    RefreshSQL.Strings = (
      'Select '
      '  ID,'
      '  REP_CREP,'
    ...
    Left = 104
    Top = 8
    object cad_rep_banID: TIntegerField
      FieldName = 'ID'
      Origin = '"CAD_REP_BAN"."ID"'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object cad_rep_banREP_CREP: TIntegerField
      FieldName = 'REP_CREP'
      Origin = '"CAD_REP_BAN"."REP_CREP"'
    end
    object cad_rep_banREP_DCAD: TDateField
      DisplayLabel = 'Cadastro'
      FieldName = 'REP_DCAD'
      Origin = '"CAD_REP_BAN"."REP_DCAD"'
    end
    object cad_rep_banREP_BANC: TIBStringField
      DisplayLabel = 'Banco'
      FieldName = 'REP_BANC'
      Origin = '"CAD_REP_BAN"."REP_BANC"'
      Size = 4
    end
    object cad_rep_banREP_DESC: TIBStringField
      DisplayLabel = 'Descri'#231#227'o'
      FieldName = 'REP_DESC'
      Origin = '"CAD_REP_BAN"."REP_DESC"'
      OnValidate = cad_rep_banREP_DESCValidate
      Size = 50
    end
    object cad_rep_banREP_AGEN: TIBStringField
      DisplayLabel = 'Agencia'
      FieldName = 'REP_AGEN'
      Origin = '"CAD_REP_BAN"."REP_AGEN"'
      Size = 10
    end
    object cad_rep_banREP_CONT: TIBStringField
      DisplayLabel = 'Conta'
      FieldName = 'REP_CONT'
      Origin = '"CAD_REP_BAN"."REP_CONT"'
      Size = 15
    end
    object cad_rep_banREP_OBSE: TMemoField
      DisplayLabel = 'Obs'
      FieldName = 'REP_OBSE'
      Origin = '"CAD_REP_BAN"."REP_OBSE"'
      ProviderFlags = [pfInUpdate]
      BlobType = ftMemo
      Size = 8
    end
    object cad_rep_banREP_TIPO: TIBStringField
      DisplayLabel = 'C.N.P.J. ou C.P.F.4'
      FieldName = 'REP_TIPO'
      Origin = '"CAD_REP_BAN"."REP_TIPO"'
    end
    object cad_rep_banREP_DOCU: TIBStringField
      DisplayLabel = 'Documento'
      FieldName = 'REP_DOCU'
      Origin = '"CAD_REP_BAN"."REP_DOCU"'
    end
  end
  object dtscad_rep_ban: TDataSource
    DataSet = cad_rep_ban
    Left = 104
    Top = 40
  end
  object cad_rep_obs: TIBDataSet
    Database = dmDADOS.ibDB
    Transaction = IBTra
    AfterCancel = cad_rep_obsAfterCancel
    AfterDelete = cad_rep_obsAfterDelete
    AfterEdit = cad_rep_obsAfterEdit
    AfterInsert = cad_rep_obsAfterEdit
    AfterPost = cad_rep_obsAfterPost
    BeforeCancel = cad_rep_obsBeforeCancel
    BeforeDelete = cad_rep_obsBeforeDelete
    OnNewRecord = cad_rep_obsNewRecord
    DeleteSQL.Strings = (
      'delete from CAD_REP_OBS'
      'where'
      '  ID = :OLD_ID')
    InsertSQL.Strings = (
      'insert into CAD_REP_OBS'
      '  (ID, OBS_CREP, OBS_DCAD, OBS_OBSE)'
      'values'
      '  (:ID, :OBS_CREP, :OBS_DCAD, :OBS_OBSE)')
    RefreshSQL.Strings = (
      'Select '
    ...
    Left = 136
    Top = 8
    object cad_rep_obsID: TIntegerField
      FieldName = 'ID'
      Origin = '"CAD_COM_OBS"."ID"'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object cad_rep_obsOBS_DCAD: TDateField
      DisplayLabel = 'Data'
      FieldName = 'OBS_DCAD'
      Origin = '"CAD_COM_OBS"."OBS_DCAD"'
    end
    object cad_rep_obsOBS_OBSE: TMemoField
      DisplayLabel = 'Obs'
      FieldName = 'OBS_OBSE'
    ...
    object cad_rep_obsOBS_CREP: TIntegerField
      FieldName = 'OBS_CREP'
      Origin = '"CAD_REP_OBS"."OBS_CREP"'
    end
  end
  object dtscad_rep_obs: TDataSource
    DataSet = cad_rep_obs
    Left = 136
    Top = 40
  end
  ...
  object cad_rep: TIBDataSet
    ...
    InsertSQL.Strings = (
      'insert into CAD_REP'
        ...
        '  (ID, REP_BAI, REP_BAIC, REP_BAIV, REP_CCEL, REP_CCM, REP_CCON,' +
        ' REP_CDD2, '
      
        '   REP_CDD3, REP_CDD4, REP_CDD5, REP_CDD6, REP_CDDD, REP_CEL, RE' +
        'P_CEP, '
      
        '   REP_CEPC, REP_CEPV, REP_CFAX, REP_CICM, REP_CID, REP_CIDC, RE' +
        'P_CIDV, '
      
        '   REP_CMAI, REP_CMUC, REP_CMUN, REP_CMUV, REP_CNCE, REP_CNID, R' +
        'EP_CNPJ, '
      
        '   REP_COMC, REP_COMI, REP_COMP, REP_COMV, REP_CONT, REP_CPAG, R' +
        'EP_CPF, '
      
        '   REP_CRED, REP_CTC1, REP_CTC2, REP_CTE1, REP_CTE2, REP_CTE3, R' +
        'EP_CTRA, '
      
        '   REP_DALT, REP_DCAD, REP_DD2, REP_DD3, REP_DD4, REP_DD5, REP_D' +
        'D6, REP_DDD, '
      
        '   REP_DFUN, REP_DPAG, REP_DTRA, REP_DULT, REP_ESTA, REP_ESTC, R' +
        'EP_ESTV, '
      
        '   REP_FANT, REP_FAX, REP_FCEL, REP_FCON, REP_FDD2, REP_FDD3, RE' +
        'P_FDD4, '
      
        '   REP_FDD5, REP_FDD6, REP_FDDD, REP_FFAX, REP_FMAI, REP_FNCE, R' +
        'EP_FNID, '
      
        '   REP_FTC1, REP_FTC2, REP_FTE1, REP_FTE2, REP_FTE3, REP_IMUN, R' +
        'EP_INSC, '
      
        '   REP_LOGC, REP_LOGR, REP_LOGV, REP_MAIL, REP_NCEL, REP_NEID, R' +
        'EP_NUMC, '
      
        '   REP_NUME, REP_NUMV, REP_OBSE, REP_OBSO, REP_RAMO, REP_RAZA, R' +
        'EP_REVE, '
      
        '   REP_RG, REP_RICM, REP_SITE, REP_STA, REP_STAV, REP_TCE1, REP_' +
        'TCE2, REP_TEL1, '
      ...
      'values'
        ...
        '  (:ID, :REP_BAI, :REP_BAIC, :REP_BAIV, :REP_CCEL, :REP_CCM, :RE' +
        'P_CCON, '
      
        '   :REP_CDD2, :REP_CDD3, :REP_CDD4, :REP_CDD5, :REP_CDD6, :REP_C' +
        'DDD, :REP_CEL, '
      
        '   :REP_CEP, :REP_CEPC, :REP_CEPV, :REP_CFAX, :REP_CICM, :REP_CI' +
        'D, :REP_CIDC, '
      
        '   :REP_CIDV, :REP_CMAI, :REP_CMUC, :REP_CMUN, :REP_CMUV, :REP_C' +
        'NCE, :REP_CNID, '
      
        '   :REP_CNPJ, :REP_COMC, :REP_COMI, :REP_COMP, :REP_COMV, :REP_C' +
        'ONT, :REP_CPAG, '
      
        '   :REP_CPF, :REP_CRED, :REP_CTC1, :REP_CTC2, :REP_CTE1, :REP_CT' +
        'E2, :REP_CTE3, '
      
        '   :REP_CTRA, :REP_DALT, :REP_DCAD, :REP_DD2, :REP_DD3, :REP_DD4' +
        ', :REP_DD5, '
      
        '   :REP_DD6, :REP_DDD, :REP_DFUN, :REP_DPAG, :REP_DTRA, :REP_DUL' +
        'T, :REP_ESTA, '
      
        '   :REP_ESTC, :REP_ESTV, :REP_FANT, :REP_FAX, :REP_FCEL, :REP_FC' +
        'ON, :REP_FDD2, '
      
        '   :REP_FDD3, :REP_FDD4, :REP_FDD5, :REP_FDD6, :REP_FDDD, :REP_F' +
        'FAX, :REP_FMAI, '
      
        '   :REP_FNCE, :REP_FNID, :REP_FTC1, :REP_FTC2, :REP_FTE1, :REP_F' +
        'TE2, :REP_FTE3, '
      
        '   :REP_IMUN, :REP_INSC, :REP_LOGC, :REP_LOGR, :REP_LOGV, :REP_M' +
        'AIL, :REP_NCEL, '
      
        '   :REP_NEID, :REP_NUMC, :REP_NUME, :REP_NUMV, :REP_OBSE, :REP_O' +
        'BSO, :REP_RAMO, '
      
        '   :REP_RAZA, :REP_REVE, :REP_RG, :REP_RICM, :REP_SITE, :REP_STA' +
        ', :REP_STAV, '
      
        '   :REP_TCE1, :REP_TCE2, :REP_TEL1, :REP_TEL2, :REP_TEL3, :REP_T' +
        'LOC, :REP_TLOG, '
      '   :REP_TLOV, :REP_TPVE, :REP_VDSC, :REP_VULT)')
    RefreshSQL.Strings = (
      'Select '
      '  ID,'
      '  REP_RAZA,'
