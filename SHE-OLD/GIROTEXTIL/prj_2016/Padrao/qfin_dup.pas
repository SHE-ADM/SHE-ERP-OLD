...
procedure Tqrpfin_dup.carregaFoto(tam: Integer; valor: TBlobField; tab: TIbDataSet; par: TIbDataSet );
var
  BlobStream : TStream;
...
begin
  ...
  begin
    ...
    begin
      ...
      SQL.Add('AND   NFE_IDBX = '' ''');
      SQL.Add('OR    NFE_TITU = '''+frmfin_dup.cadastroNFE_TITU.AsString+'''');
      SQL.Add('AND   NFE_IDBX IS NULL');
      ExecSQL;

      SQL.Clear;
      SQL.Add('UPDATE '+SLPrincipal.Values['fin_rec_ban_bai']);
      SQL.Add('SET   FIN_IDBX = ''99''');
      SQL.Add('WHERE FIN_DOCT = '''+frmfin_dup.cadastroNFE_TITU.AsString+'''');
      SQL.Add('AND   FIN_IDBX = '' ''');
      SQL.Add('OR    FIN_DOCT = '''+frmfin_dup.cadastroNFE_TITU.AsString+'''');
      SQL.Add('AND   FIN_IDBX IS NULL');
      ExecSQL;

      frmfin_dup.IBTra.CommitRetaining;
    end;
    frmfin_dup.cadastro.Next;
  end;
  frmfin_dup.cadastro.Close;
