inherited frmcad_for_edi: Tfrmcad_for_edi
      ...
      object pcmain: TdxPageControl
        ...
        object tsBAN: TdxTabSheet
          ...
          object dbgban: TdxDBGrid
            ...
            object dbgbanFOR_DCAD: TdxDBGridDateColumn
              BandIndex = 0
              RowIndex = 0
              FieldName = 'FOR_DCAD'
            end
            object dbgbanFOR_BANC: TdxDBGridMaskColumn
              Width = 41
              BandIndex = 0
              RowIndex = 0
              FieldName = 'FOR_BANC'
            end
            object dbgbanFOR_DESC: TdxDBGridPickColumn
              Width = 246
              BandIndex = 0
              RowIndex = 0
              FieldName = 'FOR_DESC'
            end
            object dbgbanFOR_AGEN: TdxDBGridMaskColumn
              Width = 52
              BandIndex = 0
              RowIndex = 0
              FieldName = 'FOR_AGEN'
            end
            object dbgbanFOR_CONT: TdxDBGridMaskColumn
              Width = 79
              BandIndex = 0
              RowIndex = 0
              FieldName = 'FOR_CONT'
            end
            object dbgbanFOR_TIPO: TdxDBGridPickColumn
              Width = 125
              BandIndex = 0
              RowIndex = 0
              FieldName = 'FOR_TIPO'
            ...
            object dbgbanFOR_DOCU: TdxDBGridMaskColumn
              Width = 141
              BandIndex = 0
              RowIndex = 0
              FieldName = 'FOR_DOCU'
            end
            object dbgbanFOR_OBSE: TdxDBGridBlobColumn
              Width = 28
              BandIndex = 0
              RowIndex = 0
              FieldName = 'FOR_OBSE'
  ...
  object cad_for_ram: TIBDataSet
    ...
    Left = 168
    Top = 8
    object cad_for_ramID: TIntegerField
      FieldName = 'ID'
      Origin = '"CAD_FOR_RAM"."ID"'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object cad_for_ramFOR_RAMO: TIBStringField
      FieldName = 'FOR_RAMO'
      Origin = '"CAD_FOR_RAM"."FOR_RAMO"'
      Size = 120
    end
  end
  object cad_for_ban: TIBDataSet
    Database = dmDADOS.ibDB
    Transaction = IBTra
    AfterCancel = cad_for_banAfterCancel
    AfterDelete = cad_for_banAfterDelete
    AfterEdit = cad_for_banAfterEdit
    AfterInsert = cad_for_banAfterEdit
    AfterPost = cad_for_banAfterPost
    BeforeCancel = cad_for_banBeforeCancel
    BeforeDelete = cad_for_banBeforeDelete
    OnNewRecord = cad_for_banNewRecord
    DeleteSQL.Strings = (
      'delete from CAD_FOR_BAN'
      'where'
      '  ID = :OLD_ID')
    InsertSQL.Strings = (
      'insert into CAD_FOR_BAN'
      
        '  (FOR_AGEN, FOR_BANC, FOR_CFOR, FOR_CONT, FOR_DCAD, FOR_DESC, F' +
        'OR_DOCU, '
      '   FOR_OBSE, FOR_TIPO, ID)'
      'values'
      
        '  (:FOR_AGEN, :FOR_BANC, :FOR_CFOR, :FOR_CONT, :FOR_DCAD, :FOR_D' +
        'ESC, :FOR_DOCU, '
      '   :FOR_OBSE, :FOR_TIPO, :ID)')
    RefreshSQL.Strings = (
      'Select '
    ...
    Left = 104
    Top = 8
    object cad_for_banFOR_CFOR: TIntegerField
      FieldName = 'FOR_CFOR'
      Origin = '"CAD_FOR_BAN"."FOR_CFOR"'
    end
    object cad_for_banFOR_DCAD: TDateField
      DisplayLabel = 'Data'
      FieldName = 'FOR_DCAD'
      Origin = '"CAD_FOR_BAN"."FOR_DCAD"'
    end
    object cad_for_banFOR_BANC: TIBStringField
      DisplayLabel = 'Banco'
      FieldName = 'FOR_BANC'
      Origin = '"CAD_FOR_BAN"."FOR_BANC"'
      Size = 4
    end
    object cad_for_banFOR_DESC: TIBStringField
      DisplayLabel = 'Descri'#231#227'o'
      FieldName = 'FOR_DESC'
      Origin = '"CAD_FOR_BAN"."FOR_DESC"'
      OnValidate = cad_for_banFOR_DESCValidate
      Size = 50
    end
    object cad_for_banFOR_AGEN: TIBStringField
      DisplayLabel = 'Agencia'
      FieldName = 'FOR_AGEN'
      Origin = '"CAD_FOR_BAN"."FOR_AGEN"'
      Size = 10
    end
    object cad_for_banFOR_CONT: TIBStringField
      DisplayLabel = 'Conta'
      FieldName = 'FOR_CONT'
      Origin = '"CAD_FOR_BAN"."FOR_CONT"'
      Size = 15
    end
    object cad_for_banFOR_OBSE: TMemoField
      DisplayLabel = 'Obs'
      FieldName = 'FOR_OBSE'
      Origin = '"CAD_FOR_BAN"."FOR_OBSE"'
      ProviderFlags = [pfInUpdate]
      BlobType = ftMemo
      Size = 8
    end
    object cad_for_banFOR_TIPO: TIBStringField
      DisplayLabel = 'Tipo'
      FieldName = 'FOR_TIPO'
      Origin = '"CAD_FOR_BAN"."FOR_TIPO"'
    end
    object cad_for_banFOR_DOCU: TIBStringField
      DisplayLabel = 'C.N.P.J. ou C.P.F.'
      FieldName = 'FOR_DOCU'
      Origin = '"CAD_FOR_BAN"."FOR_DOCU"'
    end
    object cad_for_banID: TIntegerField
      FieldName = 'ID'
  ...
  object dtscad_for_ban: TDataSource
    DataSet = cad_for_ban
    Left = 104
    Top = 40
  end
  object cad_for_obs: TIBDataSet
    Database = dmDADOS.ibDB
    Transaction = IBTra
    AfterCancel = cad_for_obsAfterCancel
    AfterDelete = cad_for_obsAfterDelete
    AfterEdit = cad_for_obsAfterEdit
    AfterInsert = cad_for_obsAfterEdit
    AfterPost = cad_for_obsAfterPost
    BeforeCancel = cad_for_obsBeforeCancel
    BeforeDelete = cad_for_obsBeforeDelete
    OnNewRecord = cad_for_obsNewRecord
    DeleteSQL.Strings = (
      'delete from CAD_FOR_OBS'
      'where'
      '  ID = :OLD_ID')
    InsertSQL.Strings = (
      'insert into CAD_FOR_OBS'
      '  (ID, OBS_CFOR, OBS_DCAD, OBS_OBSE)'
      'values'
      '  (:ID, :OBS_CFOR, :OBS_DCAD, :OBS_OBSE)')
    RefreshSQL.Strings = (
      'Select '
    ...
    Left = 136
    Top = 8
    object cad_for_obsID: TIntegerField
      FieldName = 'ID'
      Origin = '"CAD_FOR_OBS"."ID"'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object cad_for_obsOBS_CFOR: TIntegerField
      FieldName = 'OBS_CFOR'
      Origin = '"CAD_FOR_OBS"."OBS_CFOR"'
    end
    object cad_for_obsOBS_DCAD: TDateField
      DisplayLabel = 'Data'
      FieldName = 'OBS_DCAD'
      Origin = '"CAD_FOR_OBS"."OBS_DCAD"'
    end
    object cad_for_obsOBS_OBSE: TMemoField
      DisplayLabel = 'Obs'
      FieldName = 'OBS_OBSE'
      Origin = '"CAD_FOR_OBS"."OBS_OBSE"'
      ProviderFlags = [pfInUpdate]
      BlobType = ftMemo
      Size = 8
    end
  end
  object dtscad_for_obs: TDataSource
    DataSet = cad_for_obs
    Left = 136
    Top = 40
  end
  ...
  object cad_for_rep: TIBDataSet
    Database = dmDADOS.ibDB
    Transaction = IBTra
    DeleteSQL.Strings = (
      'delete from CAD_FOR_REP'
      'where'
      '  ID = :OLD_ID')
    InsertSQL.Strings = (
      'insert into CAD_FOR_REP'
      '  (ID, REP_CFOR, REP_DEMP, REP_DREP, REP_DVEN)'
      'values'
      '  (:ID, :REP_CFOR, :REP_DEMP, :REP_DREP, :REP_DVEN)')
    RefreshSQL.Strings = (
      'Select '
    ...
    Left = 72
    Top = 8
    object cad_for_repID: TIntegerField
      FieldName = 'ID'
      Origin = '"CAD_FOR_REP"."ID"'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object cad_for_repREP_CFOR: TIntegerField
      FieldName = 'REP_CFOR'
      Origin = '"CAD_FOR_REP"."REP_CFOR"'
    end
    object cad_for_repREP_DVEN: TIBStringField
      FieldName = 'REP_DVEN'
      Origin = '"CAD_FOR_REP"."REP_DVEN"'
      Size = 40
    end
    object cad_for_repREP_DREP: TIBStringField
      FieldName = 'REP_DREP'
      Origin = '"CAD_FOR_REP"."REP_DREP"'
      Size = 40
    end
    object cad_for_repREP_DEMP: TIBStringField
      FieldName = 'REP_DEMP'
      Origin = '"CAD_FOR_REP"."REP_DEMP"'
      Size = 40
    end
  end
  object dtscad_for_rep: TDataSource
    DataSet = cad_for_rep
    Left = 72
    Top = 40
  end
