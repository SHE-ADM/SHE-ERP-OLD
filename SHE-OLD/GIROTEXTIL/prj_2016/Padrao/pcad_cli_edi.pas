   ...
   begin
     ...
     begin
       ...
       begin
         if cad_cli_dsc.State = dsBrowse then
         begin
           if cad_cli_dsc.Locate('CLI_CPRO',frmprincipal.psq_proPRO_CART.AsString,[]) then
              cad_cli_dsc.Edit
           else
             cad_cli_dsc.Append;
         end;

         cad_cli_dscCLI_PTAB.Value := frmprincipal.psq_proPRO_PREC.AsFloat;
         cad_cli_dscCLI_CPRO.Value := frmprincipal.psq_proPRO_CPRO.AsString;
         cad_cli_dscCLI_DPRO.Value := frmprincipal.psq_proPRO_DPRO.AsString;
       end;
     end;  
   end;
end;
...
begin
  ...
  begin
    tsccom.Enabled := frmprincipal.ACESSO(frmprincipal.cad_usuUSU_CUSU.AsString,'USU_EDIT','Clientes','Cadastro','Comercial'                  ,false);
    tscfin.Enabled := frmprincipal.ACESSO(frmprincipal.cad_usuUSU_CUSU.AsString,'USU_EDIT','Clientes','Cadastro','Financeiro'                 ,false);
    tsccco.Enabled := frmprincipal.ACESSO(frmprincipal.cad_usuUSU_CUSU.AsString,'USU_EDIT','Clientes','Cadastro','Compras'                    ,false);
    edvdsc.Enabled := frmprincipal.ACESSO(frmprincipal.cad_usuUSU_CUSU.AsString,'USU_EDIT','Clientes','Cadastro','Desconto Pedido'            ,false);
    tsdsc.Enabled  := frmprincipal.ACESSO(frmprincipal.cad_usuUSU_CUSU.AsString,'USU_EDIT','Clientes','Cadastro','Desconto Produto'           ,false);
    tsban.Enabled  := frmprincipal.ACESSO(frmprincipal.cad_usuUSU_CUSU.AsString,'USU_EDIT','Clientes','Cadastro','Informações Bancárias'      ,false);
    tsicom.Enabled := frmprincipal.ACESSO(frmprincipal.cad_usuUSU_CUSU.AsString,'USU_EDIT','Clientes','Cadastro','Informações Comerciais'     ,false);
    edcred.Enabled := frmprincipal.ACESSO(frmprincipal.cad_usuUSU_CUSU.AsString,'USU_EDIT','Clientes','Cadastro','Limite de Crédito'          ,false);
    ts2.Enabled    := frmprincipal.ACESSO(frmprincipal.cad_usuUSU_CUSU.AsString,'USU_EDIT','Clientes','Cadastro','Ocorrências'                ,false);
    cbramo.Enabled := frmprincipal.ACESSO(frmprincipal.cad_usuUSU_CUSU.AsString,'USU_EDIT','Clientes','Cadastro','Ramo de Atividades'         ,false);
    cbdven.Enabled := frmprincipal.ACESSO(frmprincipal.cad_usuUSU_CUSU.AsString,'USU_EDIT','Clientes','Cadastro','Vendedores / Representantes',false);
    cbdrep.Enabled := frmprincipal.ACESSO(frmprincipal.cad_usuUSU_CUSU.AsString,'USU_EDIT','Clientes','Cadastro','Vendedores / Representantes',false);
    cbstav.Enabled := frmprincipal.ACESSO(frmprincipal.cad_usuUSU_CUSU.AsString,'USU_EDIT','Clientes','Cadastro','Status'                     ,false);
...
begin
  ...
  begin
    ...
    if not frmprincipal.ACESSO(frmprincipal.cad_usuUSU_CUSU.AsString,'USU_AUTO','Financeiro','Contas a Receber','Liberar Limite de Crédito Excedido',false) then
    raise exception.Create('ACESSO NEGADO !'+#13+'Contate o admnistrador do sistema.');
  end;
...
begin
  ...
  begin
    ...
    begin
      ...
      SelectSQL.Add('WHERE ID = '''+frmcad_cli.cadastroID.AsString+'''');
      Open;
