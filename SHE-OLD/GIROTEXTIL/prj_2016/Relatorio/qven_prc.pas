...
type
  Tqrpven_prc = class(TQuickRep)
    ...
    ven_efePRO_CFOR: TIBStringField;
...
procedure Tqrpven_prc.carregaFoto(tam: Integer; valor: TBlobField; tab: TIbDataSet; par: TIbDataSet );
var
  BlobStream : TStream;
...
procedure Tqrpven_prc.carregaFoto2(tam: Integer; valor: TBlobField; tab: TIbDataSet; par: TIbDataSet );
var
  BlobStream : TStream;
  JPEGImage : TJPEGImage;
begin
...
procedure Tqrpven_prc.ColumnHeaderBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  qrlcfor.Caption := strzero(romanROM_CFOR.AsInteger,10);
