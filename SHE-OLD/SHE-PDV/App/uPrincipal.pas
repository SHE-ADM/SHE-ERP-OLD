...
uses bPrincipal, pSobre, pCAD_PRO_PSQ, pPSQEND, pPSQCAD, pLogin, pSenha,
  pImpressoras, pProduto_Pesquisa, pPesquisaCodigoMunicipal,
  pPesquisaLogradouros, pProduto_Imagem, pcad_cli_inf, pConsultaCNPJ,
  pcad_cli, pcad_rep, pcad_tra, pcad_for, pProduto, ptab_nat, ptab_pag,
  pNFeConsulta, pctr_prg, pctr_ped, pctr_rom, pctr_nfe, pven_nfe, pven_nfd,
  pNFeSaidaConsulta, pNFeSaida, pRelatorios;
