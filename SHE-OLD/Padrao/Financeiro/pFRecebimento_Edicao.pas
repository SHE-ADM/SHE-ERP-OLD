...
begin
  ...
  begin
    ...
    SQL.Add('FROM '+REC_SHE_DEF.FB_TB_PK+' AS FR');
    ...
    begin
      ...
      ACDBX := '0';
      ASTDO := IFThen(Pos('BAN',UpperCase(REC_SHE_DEF.FB_TB_PK)) > 0,'B 1','C 1');
      ...
      IETipo.Text   := IFThen(Pos('BAN',UpperCase(REC_SHE_DEF.FB_TB_PK)) > 0,'DUPLICATA','CARTEIRA');
...
begin
  ...
  try
    ...
    begin
      ...
      SQL.Add('INTO '+REC_SHE_DEF.FB_TB_PK);
      SQL.Add('(');
      SQL.Add('ID,FIN_CDCX,');
