...
procedure TFrmCAD_PRO_EDI._WM_SHOW(var Msg: TMessage);
begin
  inherited;
  with SQLConsulta do
  begin
...
procedure TFrmCAD_PRO_EDI._WM_AFTER_SHOW(var Msg: TMessage);
begin
  inherited;
  _CAD_PRO_CMP;
...
//    CEUQTDE_EST_MIN_LV.Value := Current.ByName('UQTDE_EST_MIN_SITE').AsCurrency;
    ...
    begin
      ...
      begin
        ...
        CAD_PRO_GRDGRD_RGRD.Value := Current.ByName('VAR_NO_RF').AsString;
        ...
        CAD_PRO_GRDDGCP.Value := Current.ByName('CP_NO_GRD').AsString;
