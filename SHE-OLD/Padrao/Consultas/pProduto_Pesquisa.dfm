object FrmProduto_Pesquisa: TFrmProduto_Pesquisa
  Left = 438
  Top = 139
  ...
  object PNLPrincipal: TPanel
    ...
    object GBArtigo: TGroupBox
      ...
      object DBGConsulta: TdxDBGrid
        ...
        object DBGConsultaC_EST_QTRL: TdxDBGridColumn
          Color = clWhite
          HeaderAlignment = taRightJustify
          Width = 42
          BandIndex = 1
        ...
        object DBGConsultaC_VPRC_PAD: TdxDBGridMaskColumn
          Color = clGray
          Font.Charset = ANSI_CHARSET
          Font.Color = clWhite
          Font.Height = -12
          ...
          SummaryFooterField = 'C_VPRC_PAD'
          SummaryFooterFormat = ',##,0.00'
          DisableFilter = True
        end
        object DBGConsultaC_VPRC_PRZ: TdxDBGridColumn
          Color = clGray
          Font.Charset = ANSI_CHARSET
          Font.Color = clWhite
          Font.Height = -12
          ...
          SummaryFooterType = cstAvg
          SummaryFooterField = 'C_VPRC_PRZ'
          SummaryFooterFormat = ',##,0.00'
          DisableFilter = True
        end
        object DBGConsultaC_VPRC_PRO: TdxDBGridColumn
          Color = clGray
          Font.Charset = ANSI_CHARSET
          Font.Color = clWhite
          Font.Height = -12
        ...
        object DBGConsultaVPRC_REP: TdxDBGridMaskColumn
          ...
          FieldName = 'VPRC_REP'
          SummaryFooterType = cstAvg
          SummaryFooterField = 'VPRC_REP'
          SummaryFooterFormat = ',##,0.00'
          DisableFilter = True
        end
        object DBGConsultaVPRC_SITE: TdxDBGridMaskColumn
          HeaderAlignment = taRightJustify
          Width = 75
          BandIndex = 5
          RowIndex = 0
          FieldName = 'VPRC_SITE'
          SummaryFooterType = cstAvg
          SummaryFooterField = 'VPRC_SITE'
          SummaryFooterFormat = ',##,0.00'
          DisableFilter = True
        end
        object DBGConsultaVPRC_COMPRA: TdxDBGridMaskColumn
          Color = clGray
          Font.Charset = ANSI_CHARSET
          Font.Color = clWhite
          Font.Height = -12
          ...
          BandIndex = 6
          RowIndex = 0
          FieldName = 'VPRC_COMPRA'
          SummaryFooterType = cstAvg
          SummaryFooterField = 'VPRC_COMPRA'
          SummaryFooterFormat = ',##,0.00'
          DisableFilter = True
        end
        object DBGConsultaVPRC_COMPRA_IMP: TdxDBGridMaskColumn
          Color = clGray
          Font.Charset = ANSI_CHARSET
          Font.Color = clWhite
          Font.Height = -12
          ...
          BandIndex = 6
          RowIndex = 0
          FieldName = 'VPRC_COMPRA_IMP'
          SummaryFooterType = cstAvg
          SummaryFooterField = 'VPRC_COMPRA_IMP'
          SummaryFooterFormat = ',##,0.00'
          DisableFilter = True
        end
        ...
        object DBGConsultaPIPI: TdxDBGridCurrencyColumn
          Color = clWhite
          HeaderAlignment = taRightJustify
          Width = 45
          BandIndex = 7
  ...
  object TCAD_PRO_IMG: TIBTransaction
    Active = True
