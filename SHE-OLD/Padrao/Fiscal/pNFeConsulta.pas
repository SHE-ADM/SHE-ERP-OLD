...
uses
  ...
  dxDBTLCl, dxGrClms, IBSQL, ActnList;
...
type
  TFrmNFeConsulta = class(TFrmPadr3)
    ...
    dxDBEdit3: TdxDBEdit;
    dxDBEdit4: TdxDBEdit;
    ConsultaNotaFiscal: TIntegerField;
    ConsultaDTEmissao: TDateField;
    ConsultaDTSaida: TDateField;
    ConsultaChave: TIBStringField;
    ConsultaPROTAutoricado: TIBStringField;
    ConsultaPROTCancelado: TIBStringField;
    ConsultaFinalidade: TIBStringField;
    ConsultaCFOP: TIBStringField;
    ConsultaTransportadora: TIBStringField;
    ConsultaVolume: TIBStringField;
    ConsultaPesoB: TIBBCDField;
    ConsultaPesoL: TIBBCDField;
    ConsultaFavorecido: TIBStringField;
    ConsultaPedido: TIBStringField;
    ConsultaDTPedido: TDateField;
    ConsultaTPPedido: TIBStringField;
    ConsultaTPCobranca: TIBStringField;
    ConsultaInfoPed: TMemoField;
    ConsultaRevisor: TIBStringField;
    ConsultaPrazo: TIBStringField;
    ConsultaRomaneio: TIntegerField;
    ConsultaDTRomaneio: TDateField;
    ConsultaCobranca: TIBStringField;
    ConsultaTitulo: TIBStringField;
    ConsultaDTVencto: TDateField;
    ConsultaVLTitulo: TIBBCDField;
    ConsultaSTTitulo: TIBStringField;
    ...
    ConsultaInfoNFe: TMemoField;
    ConsultaVendedor: TIBStringField;
    ConsultaRepresentante: TIBStringField;
    ConsultaEnvDup: TIBStringField;
    ConsultaEnvBan: TIBStringField;
