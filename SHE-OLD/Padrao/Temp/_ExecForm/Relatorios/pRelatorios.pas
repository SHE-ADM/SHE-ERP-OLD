...
uses uPrincipal, bPrincipal,
  qGerencial_Estoque_Unidade_Medida,
  qGerencial_NF_Peso,
  ...
  case RECRelatorios.Perfil of
   ...
   14: begin
         ...
         begin
           ...
           if (RECParametros.EP_GE <> EmptyStr) and (IEEmpresa.Enabled) then
           begin
             PEC1Consulta.Items.Add(RECParametros.EP_GE);
             PEC1Consulta.Text := RECParametros.EP_GE;
           end;
         end else
