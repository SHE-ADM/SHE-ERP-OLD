...
begin
  ...
  CadastroCDST.Value := RECParametros.STA_CDST;
  CadastroREST.Value := RECParametros.STA_REST;
...
begin
  try
    ...
    _Inicializa_Precos;
    try
       TFrmProduto_Preco_Faixa_Comissao._ExecForm(Self,FrmProduto_Preco_Faixa_Comissao,False,fsStayOnTop);
