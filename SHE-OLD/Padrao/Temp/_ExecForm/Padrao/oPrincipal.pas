...
begin
  ...
  if AREC_SHE_DEF.AIDPK = 0 then
     ...
     begin
      ...
      ExecQuery;
      AREC_SHE_DEF.AIDPK := IntToStr(Current.Vars[0].AsInteger + 1);
     end;
  ...
  BarCode := LeftStr('789' + AREC_SHE_DEF.AIDPK + oStrZero(StrToInt(LeftStr(BarCode,8)),9-Length(AREC_SHE_DEF.AIDPK)),12);
             ...
             try
               ...
               begin
                 ...
                 begin
                   ...
                   TImage(AIMG_PAD).Hint := 'Dimensão: ' + IntToStr(FTJpeg.Width) + 'x' + IntToStr(FTJpeg.Height) + ' - ' + Format('Tamanho: %f KB',[FTStream.Size / 1000]);
                 end;
               end else
               if AIMG_PAD.ClassType = TImage then
               begin
