...
begin
  ...
  FormatDateTime('yyyy-mm-dd',Date)+'T'+FormatDatetime('hh:mm:ss',Now)+RECParametros.NFE_TIMEZONE, //Data e hora do evento no formato AAAA-MMDDThh:mm:ssTZD
...
begin
  ...
  try
    ...
    frmemail.edtitulo.Text := RECParametros.EP_NO+' - CCe.: '+edcdnf.Text;
