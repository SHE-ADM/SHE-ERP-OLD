...
begin
  ...
  if FileExists(PChar(RECParametros.PATH_SHE + '\' + RECParametros.PATH_CFE + '\Envia\Retorno\'+EDNumero.Text+'.txt')) then
     try
       AssignFile(TFArquivo,PAnsiChar(RECParametros.PATH_SHE + '\' + RECParametros.PATH_CFE + '\Envia\Retorno\'+EDNumero.Text+'.txt'));
       Reset(TFArquivo);
...
procedure TFrmCFeSat.RSBCupomClick(Sender: TObject);
          ...
          var
            ...
            ARQTxt2: PAnsiChar;
          begin
            ARQTxt  := PAnsiChar(RECParametros.PATH_SHE + '\' + RECParametros.PATH_CFE + '\Txt\'  +EDNumero.Text+'.txt');
            ARQTxt2 := PAnsiChar(RECParametros.PATH_SHE + '\' + RECParametros.PATH_CFE + '\Envia\'+EDNumero.Text+'.txt');
            try
              ...
              WriteLN(TFTxt,'CNPJ_B11='+RECParametros.CFE_API_CNPJ);
