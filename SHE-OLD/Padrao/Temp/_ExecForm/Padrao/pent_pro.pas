...
begin
  ...
  REC_SHE_DEF.FB_PSQ_TB_NO_PK := 'CAD_PRO_ENI';
...
begin
  ...
  uSP_CAD_PRO_EST_LAN_UPD(REC_SHE_DEF.FB_PSQ_TB_NO_PK,INTTOSTR(RECParametros.EP_ID),CECDRO.Text,CECDRO.Text,'PK.CDRO');
end;
