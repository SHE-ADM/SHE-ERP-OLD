...
begin
  ...
  17: begin
   ...
   95: begin
         ...
         APSQ_REC := IFThen(APSQ_REC = '','Título',APSQ_REC);
         cbcampo.Text := APSQ_REC;
  ...
  begin
    ...
    begin
      case tag of
         ...
         98,
         99: begin
               if (((Pos(LeftStr(cbCAMPO.Text,2),'NºCóNFRO') > 0) or (cbCAMPO.Text = 'Nota Fiscal') or (cbCAMPO.Text = 'Pedido') or (cbCAMPO.Text = 'B2B') or (cbCAMPO.Text = 'B2C')) and
