...
procedure TFrmPadr5.FormCloseQuery(Sender: TObject; var CanClose: Boolean);
begin
  { VER ANTES DE SAIR }
end;
...
procedure TFrmPadr5.CadastroBeforeOpen(DataSet: TDataSet);
begin
  { INICIALIZA FORM SCREEN }
  Screen.Cursor := crHourGlass;
end;

procedure TFrmPadr5.CadastroAfterOpen(DataSet: TDataSet);
begin
  { FINALIZA FORM SCREEN }
  Screen.Cursor := crDefault;
...
procedure TFrmPadr5.CadastroCalcFields(DataSet: TDataSet);
begin
  CadastroC_ID.Value := Cadastro.RecNo;
end;

procedure TFrmPadr5.DTSCadastroDataChange(Sender: TObject; Field: TField);
begin
  { nothing }
end;

procedure TFrmPadr5.DTSCadastroStateChange(Sender: TObject);
begin
  { nothing }
end;
