...
uses
  ...
  IBSQL, pPadr2, ActnList, dxBar, dxDockControl, dxDockPanel;
...
begin
  ...
  REC_SHE_DEF.FB_Event := 'FIS_NFE_ADM';
  ...
  begin
    ...
    SQL.Add('WHERE    CAST(PK.DTCA AS DATE) BETWEEN ''' + RECParametros.DTMES_INI_FMT + ''' AND ''' + RECParametros.DTMES_FIM_FMT + '''');
  ...
  try
    ...
    begin
      ...
      begin
        ...
        nfe_001NFE_ITEMPED.Value := nfe_iteNFE_ITEMPED.AsInteger;
        nfe_001NFE_CFOP.Value    := IFThen(ATipo = 0,nfe_iteNFE_CFOP.AsString,
        ...
        nfe_001NFE_CPROD.Value := nfe_iteNFE_CPROD.AsString;
        nfe_001NFE_CEAN.Value  := nfe_iteNFE_CEAN.AsString;
        nfe_001NFE_XPROD.Value := nfe_iteNFE_XPROD.AsString;
        nfe_001NFE_UCOM.Value  := nfe_iteNFE_UCOM.AsString;

        nfe_001NFE_NCM.Value    := nfe_iteNFE_NCM.AsString;
        nfe_001NFE_PIPI.Value   := nfe_iteNFE_PIPI.AsFloat;
        nfe_001NFE_CEST.Value   := nfe_iteNFE_CEST.AsString;
        nfe_001NFE_EXTIPI.Value := nfe_iteNFE_EXTIPI.AsString;

        nfe_001NFE_ORIG.Value   := nfe_iteNFE_ORIG.AsString;

        nfe_001NFE_QCOM.AsFloat := nfe_iteNFE_QCOM.AsFloat;
        nfe_001NFE_RCOM.Value   := nfe_iteNFE_RCOM.AsInteger;

        nfe_001NFE_PREC.Value   := nfe_iteNFE_VUNCOM.AsFloat;
        nfe_001NFE_VUNCOM.Value := nfe_iteNFE_VUNCOM.AsFloat;

        nfe_001NFE_NFCI.Value := nfe_iteNFE_NFCI.AsString;

        nfe_001NFE_PSCN.Value := nfe_itePSCN.AsFloat;
        nfe_001NFE_PSBR.Value := nfe_itePSBR.AsFloat;
        nfe_001NFE_PSLQ.Value := nfe_itePSLQ.AsFloat;
