...
uses
  ...
  rxSpeedbar, IBSQL, ActnList, dxDockControl, dxsbar, dxDockPanel;
...
type
  TFrmCAD_PRO_EDI = class(TFrmPadr3)
    ...
    DSMEDIDAS: TdxDockSite;
    dxLayoutDockSite2: TdxLayoutDockSite;
    TCDSMEDIDAS: TdxTabContainerDockSite;
    DPMED_LJF: TdxDockPanel;
    PNLUCOM: TPanel;
    GBMEDVEN: TGroupBox;
    LAUCOM: TLabel;
    LAUESP: TLabel;
    ...
    EMINFADCAD: TdxMemo;
    DSRevendedor: TdxDockSite;
    dxLayoutDockSite1: TdxLayoutDockSite;
    DPRevendedor: TdxDockPanel;
    DSFabricante: TdxDockSite;
    dxLayoutDockSite3: TdxLayoutDockSite;
    DPFabricante: TdxDockPanel;
    ...
    PNLFRevendedor: TPanel;
    PNLFFabricante: TPanel;
    PNLERevendedor: TPanel;
    LAARTIGO: TLabel;
    LAIDEP: TLabel;
    LADECP: TLabel;
    LADCCP: TLabel;
    ...
    dxCheckEdit5: TdxCheckEdit;
    dxCheckEdit6: TdxCheckEdit;
    dxCheckEdit7: TdxCheckEdit;
    ...
    procedure EDDCCPChange(Sender: TObject);
  private
...
begin
  EDDECP.Font.Size := Length(EDDECP.Text) > 60,8,9);
end;

procedure TFrmCAD_PRO_EDI.EDDCCPChange(Sender: TObject);
begin
  EDDCCP.Font.Size := Length(EDDCCP.Text) > 60,8,9);
end;
