inherited frmctr_rom: Tfrmctr_rom
  ...
  inherited SpeedBar2: TSpeedBar
    ...
    inherited siLIXO: TSpeedItem [5]
      Hint = 'Recupera Itens Deletados'
      ImageIndex = 6
    end
    ...
    inherited siSAIR: TSpeedItem [10]
      ImageIndex = 3
      Left = 663
    end
  ...
  object dtsrom_ite: TDataSource [5]
    DataSet = rom_ite
  ...
  object SQLFKEdicao: TIBSQL [8]
    Database = FBird.DBERP
    Transaction = FBird.TFBEdicao
    Left = 184
    Top = 192
  end
  object SQLFKConsulta: TIBSQL [9]
    Database = FBird.DBERP
    Transaction = FBird.TFBEdicao
    Left = 184
    Top = 160
  end
  object CAD_PRO_IMG: TIBQuery [10]
    Database = FBird.DBERP
    Transaction = FBird.TFBEdicao
    DataSource = dtsrom_ite
    SQL.Strings = (
  ...
  object DTSCAD_PRO_IMG: TDataSource [11]
    AutoEdit = False
    DataSet = CAD_PRO_IMG
  ...
  inherited ALPrincipal: TActionList
    inherited ACTExecEvent: TAction
      OnExecute = nil
    end
  end
end
