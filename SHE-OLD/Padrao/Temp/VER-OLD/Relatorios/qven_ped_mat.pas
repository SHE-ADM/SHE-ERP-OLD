...
uses oPrincipal,
  Windows, SysUtils, Messages, Classes, Graphics, Controls, DateUtils,
  StdCtrls, ExtCtrls, Forms, QuickRpt, QRCtrls, DB,
  IBCustomDataSet, IBQuery, IBDatabase, IBStoredProc, IBSQL;
...
begin
  ...
  qrlOPED.Lines.Clear;
  qrlOPED.Lines.Add(TRIM(FBird.CDSFBParametrosPAR_OPED.AsString));
