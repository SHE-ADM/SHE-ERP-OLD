...
uses
  ...
  qven_ped in '..\Relatórios\qven_ped.pas' {qrpven_ped: TQuickRep},
  prelatorio_geral in '..\Relatórios\prelatorio_geral.pas' {frmrelatorio_geral},
  parquivo_geral in '..\Padrao\parquivo_geral.pas' {frmarquivo_geral},
  qven_con in '..\Relatórios\qven_con.pas' {qrpven_con: TQuickRep},
  qcai_mov_flx_ban in '..\Relatórios\qcai_mov_flx_ban.pas' {qrpcai_mov_flx_ban: TQuickRep},
  qcai_mov_flx_car in '..\Relatórios\qcai_mov_flx_car.pas' {qrpcai_mov_flx_car: TQuickRep},
  qcai_mov_cai_ana in '..\Relatórios\qcai_mov_cai_ana.pas' {qrpcai_mov_cai_ana: TQuickRep},
  qcai_mov_cai_sin in '..\Relatórios\qcai_mov_cai_sin.pas' {qrpcai_mov_cai_sin: TQuickRep},
  qcai_mov_ger in '..\Relatórios\qcai_mov_ger.pas' {qrpcai_mov_ger: TQuickRep},
  qcai_mov_flx_ven in '..\Relatórios\qcai_mov_flx_ven.pas' {qrpcai_mov_flx_ven: TQuickRep},
  qcai_mov_flx_rep in '..\Relatórios\qcai_mov_flx_rep.pas' {qrpcai_mov_flx_rep: TQuickRep},
  qcai_mov_ger_ana in '..\Relatórios\qcai_mov_ger_ana.pas' {qrpcai_mov_ger_ana: TQuickRep},
  qFicha_Tecnica in '..\Relatórios\qFicha_Tecnica.pas' {qrpFicha_Tecnica: TQuickRep},
  ...
  qPED_CUP_SCO in '..\Relatórios\Pedidos\qPED_CUP_SCO.pas' {QRPPED_CUP_SCO: TQuickRep},
  qPED_CUP_VEN in '..\Relatórios\Pedidos\qPED_CUP_VEN.pas' {QRPPED_CUP_VEN: TQuickRep},
  qFIN_PAG_COM_PED in '..\Relatórios\Pagamentos\qFIN_PAG_COM_PED.pas' {QRPFIN_PAG_COM_PED: TQuickRep},
  QFIN_PAG_COM in '..\Relatórios\Pagamentos\qFIN_PAG_COM.pas' {QRPFIN_PAG_COM: TQuickRep},
