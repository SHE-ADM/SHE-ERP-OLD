    ...
    object GBConsulta: TGroupBox
      ...
      object DBGConsulta: TdxDBGrid
        ...
        Bands = <
          ...
          item
            Caption = 'Estoque Pronta Entrega'
          end
          item
        ...
        object DBGConsultaEPE_QTDE: TdxDBGridColumn
          Font.Charset = ANSI_CHARSET
          Font.Color = clWindowText
          Font.Height = -12
          Font.Name = 'Tahoma'
        ...
        object DBGConsultaVPRC_PAD: TdxDBGridMaskColumn
          Color = clGray
          Font.Charset = ANSI_CHARSET
          Font.Color = clWhite
          Font.Height = -12
        ...
        object DBGConsultaVPRC_VAR: TdxDBGridMaskColumn
          Color = clSilver
          HeaderAlignment = taRightJustify
          Width = 70
          BandIndex = 2
        ...
        object DBGConsultaVPRC_REP: TdxDBGridMaskColumn
          Color = clBtnFace
          HeaderAlignment = taRightJustify
          Width = 70
          BandIndex = 2
  ...
  object Cadastro: TIBQuery
    ...
    SQL.Strings = (
      ...
      'FROM      VW_CAD_PRO_PSQ  AS PK'
        ...
        'LEFT JOIN CAD_PRO_EST_LAN AS FK ON (FK.IDEP_LOG = :IDEP AND FK.I' +
        'DEK = PK.IDEK)'
      'WHERE     PK.ARTIGO = 0'
      'ORDER BY  ARTIGO,DGCP')
    Left = 400
    Top = 200
    ParamData = <
      item
    ...
    object CadastroIDEP: TSmallintField
      FieldName = 'IDEP'
      Origin = '"VW_CAD_PRO_PSQ"."IDEP"'
    end
    object CadastroDEEP: TIBStringField
      FieldName = 'DEEP'
      Origin = '"VW_CAD_PRO_PSQ"."DEEP"'
      Size = 40
    end
    object CadastroIDCA: TSmallintField
      FieldName = 'IDCA'
      Origin = '"VW_CAD_PRO_PSQ"."IDCA"'
    end
    object CadastroDTCA: TDateTimeField
      FieldName = 'DTCA'
      Origin = '"VW_CAD_PRO_PSQ"."DTCA"'
    end
    ...
    object CadastroIDED: TSmallintField
      FieldName = 'IDED'
      Origin = '"VW_CAD_PRO_PSQ"."IDED"'
    end
    object CadastroDTED: TDateTimeField
      FieldName = 'DTED'
      Origin = '"VW_CAD_PRO_PSQ"."DTED"'
    end
    object CadastroIDST: TSmallintField
      FieldName = 'IDST'
      Origin = '"VW_CAD_PRO_PSQ"."IDST"'
    end
    object CadastroDTST: TDateTimeField
      FieldName = 'DTST'
      Origin = '"VW_CAD_PRO_PSQ"."DTST"'
    end
    object CadastroCDST: TSmallintField
      FieldName = 'CDST'
      Origin = '"VW_CAD_PRO_PSQ"."CDST"'
    end
    object CadastroREST: TIBStringField
      FieldName = 'REST'
      Origin = '"VW_CAD_PRO_PSQ"."REST"'
      Size = 10
    end
    object CadastroDEST: TIBStringField
      DisplayLabel = 'Situa'#231#227'o'
      FieldName = 'DEST'
      Origin = '"VW_CAD_PRO_PSQ"."DEST"'
      Size = 60
    end
    object CadastroDTEK: TDateTimeField
      FieldName = 'DTEK'
      Origin = '"VW_CAD_PRO_PSQ"."DTEK"'
    end
    object CadastroDTSP: TDateTimeField
      FieldName = 'DTSP'
      Origin = '"VW_CAD_PRO_PSQ"."DTSP"'
    end
    object CadastroDTPV: TDateTimeField
      FieldName = 'DTPV'
      Origin = '"VW_CAD_PRO_PSQ"."DTPV"'
    end
    object CadastroARTIGO: TIBStringField
      FieldName = 'ARTIGO'
      Origin = '"VW_CAD_PRO_PSQ"."ARTIGO"'
      Size = 30
    end
    ...
    object CadastroNCM: TIBStringField
      FieldName = 'NCM'
      Origin = '"VW_CAD_PRO_PSQ"."NCM"'
      Size = 8
    end
    object CadastroPIPI: TIBBCDField
      FieldName = 'PIPI'
      Origin = '"VW_CAD_PRO_PSQ"."PIPI"'
      Precision = 9
      Size = 2
    end
    object CadastroSKU: TIBStringField
      FieldName = 'SKU'
      Origin = '"VW_CAD_PRO_PSQ"."SKU"'
      Size = 30
    end
    object CadastroCEAN: TIBStringField
      FieldName = 'CEAN'
      Origin = '"VW_CAD_PRO_PSQ"."CEAN"'
    end
    object CadastroIDEK: TLargeintField
      FieldName = 'IDEK'
    ...
    object CadastroDECP: TIBStringField
      ...
      FieldName = 'DECP'
      Origin = '"VW_CAD_PRO_PSQ"."DECP"'
      Size = 120
    end
    object CadastroDGCP: TIBStringField
      DisplayLabel = 'Grade'
      FieldName = 'DGCP'
      Origin = '"VW_CAD_PRO_PSQ"."DGCP"'
      Size = 60
    end
    ...
    object CadastroUCOM: TIBStringField
      ...
      FieldName = 'UCOM'
      Origin = '"VW_CAD_PRO_PSQ"."UCOM"'
      Size = 10
    end
    object CadastroEPE_QTDE: TIBBCDField
    ...
    object CadastroEPE_QTRL: TIntegerField
      FieldName = 'EPE_QTRL'
      ProviderFlags = []
    end
    ...
    object CadastroCF_SKU: TIBStringField
      FieldName = 'CF_SKU'
      Origin = '"VW_CAD_PRO_PSQ"."CF_SKU"'
      Size = 30
    end
    object CadastroCF_CEAN: TIBStringField
      FieldName = 'CF_CEAN'
      Origin = '"VW_CAD_PRO_PSQ"."CF_CEAN"'
    end
    object CadastroCF_VPRC_PAD_ORI: TIBStringField
      FieldName = 'CF_VPRC_PAD_ORI'
      Origin = '"VW_CAD_PRO_PSQ"."CF_VPRC_PAD_ORI"'
      FixedChar = True
      Size = 2
    end
    object CadastroCF_VPRC_PAD: TFloatField
      FieldName = 'CF_VPRC_PAD'
      Origin = '"VW_CAD_PRO_PSQ"."CF_VPRC_PAD"'
    end
    object CadastroVPRC_PAD_INI: TFloatField
      FieldName = 'VPRC_PAD_INI'
      Origin = '"VW_CAD_PRO_PSQ"."VPRC_PAD_INI"'
      DisplayFormat = ',##,0.00'
    end
    object CadastroVPRC_PAD_FIM: TFloatField
      FieldName = 'VPRC_PAD_FIM'
      Origin = '"VW_CAD_PRO_PSQ"."VPRC_PAD_FIM"'
      DisplayFormat = ',##,0.00'
    end
    object CadastroVPRC_PAD: TFloatField
      DisplayLabel = 'Atacado'
      FieldName = 'VPRC_PAD'
      Origin = '"VW_CAD_PRO_PSQ"."VPRC_PAD"'
      DisplayFormat = 'R$ ,##,0.00'
    end
    object CadastroVPRC_PAD_PRZ: TFloatField
      FieldName = 'VPRC_PAD_PRZ'
      Origin = '"VW_CAD_PRO_PSQ"."VPRC_PAD_PRZ"'
      DisplayFormat = ',##,0.00'
    end
    object CadastroVPRC_PAD_PRO: TFloatField
      FieldName = 'VPRC_PAD_PRO'
      Origin = '"VW_CAD_PRO_PSQ"."VPRC_PAD_PRO"'
      DisplayFormat = ',##,0.00'
    end
    object CadastroVPRC_VAR: TFloatField
      DisplayLabel = 'Varejo'
      FieldName = 'VPRC_VAR'
      Origin = '"VW_CAD_PRO_PSQ"."VPRC_VAR"'
      DisplayFormat = 'R$ ,##,0.00'
    end
    object CadastroVPRC_VAR_PRZ: TFloatField
      FieldName = 'VPRC_VAR_PRZ'
      Origin = '"VW_CAD_PRO_PSQ"."VPRC_VAR_PRZ"'
      DisplayFormat = ',##,0.00'
    end
    object CadastroVPRC_VAR_PRO: TFloatField
      FieldName = 'VPRC_VAR_PRO'
      Origin = '"VW_CAD_PRO_PSQ"."VPRC_VAR_PRO"'
      DisplayFormat = ',##,0.00'
    end
    object CadastroVPRC_REP: TFloatField
      DisplayLabel = 'Representante'
      FieldName = 'VPRC_REP'
      Origin = '"VW_CAD_PRO_PSQ"."VPRC_REP"'
      DisplayFormat = 'R$ ,##,0.00'
    end
    object CadastroVPRC_REP_PRZ: TFloatField
      FieldName = 'VPRC_REP_PRZ'
      Origin = '"VW_CAD_PRO_PSQ"."VPRC_REP_PRZ"'
      DisplayFormat = ',##,0.00'
    end
    object CadastroVPRC_REP_PRO: TFloatField
      FieldName = 'VPRC_REP_PRO'
      Origin = '"VW_CAD_PRO_PSQ"."VPRC_REP_PRO"'
      DisplayFormat = ',##,0.00'
    end
    object CadastroPESO: TIBBCDField
      FieldName = 'PESO'
      Origin = '"VW_CAD_PRO_PSQ"."PESO"'
      Precision = 9
      Size = 2
    end
    object CadastroPSCN: TIBBCDField
      FieldName = 'PSCN'
      Origin = '"VW_CAD_PRO_PSQ"."PSCN"'
      Precision = 9
      Size = 2
    end
    object CadastroMETRO: TIBBCDField
      FieldName = 'METRO'
      Origin = '"VW_CAD_PRO_PSQ"."METRO"'
      Precision = 9
      Size = 2
    end
    object CadastroREND: TIBBCDField
      FieldName = 'REND'
      Origin = '"VW_CAD_PRO_PSQ"."REND"'
      Precision = 9
      Size = 2
    end
    object CadastroGRAM: TIBBCDField
      FieldName = 'GRAM'
      Origin = '"VW_CAD_PRO_PSQ"."GRAM"'
      Precision = 9
      Size = 2
    end
    object CadastroLARU: TIBBCDField
      FieldName = 'LARU'
      Origin = '"VW_CAD_PRO_PSQ"."LARU"'
      Precision = 9
      Size = 2
    end
    object CadastroLART: TIBBCDField
      FieldName = 'LART'
      Origin = '"VW_CAD_PRO_PSQ"."LART"'
      Precision = 9
      Size = 2
    end
    object CadastroELAL: TIBBCDField
      FieldName = 'ELAL'
      Origin = '"VW_CAD_PRO_PSQ"."ELAL"'
      Precision = 9
      Size = 2
    end
    object CadastroELAC: TIBBCDField
      FieldName = 'ELAC'
      Origin = '"VW_CAD_PRO_PSQ"."ELAC"'
      Precision = 9
      Size = 2
    end
    object CadastroCOL_ID: TIntegerField
      FieldName = 'COL_ID'
      Origin = '"VW_CAD_PRO_PSQ"."COL_ID"'
    end
    object CadastroCOL_NO: TIBStringField
      FieldName = 'COL_NO'
      Origin = '"VW_CAD_PRO_PSQ"."COL_NO"'
      Size = 30
    end
    ...
    object CadastroORIG: TSmallintField
      FieldName = 'ORIG'
      Origin = '"VW_CAD_PRO_PSQ"."ORIG"'
    end
    object CadastroD_ORIG: TIBStringField
      FieldKind = fkInternalCalc
      FieldName = 'D_ORIG'
      Origin = '"VW_CAD_PRO_PSQ"."D_ORIG"'
      ProviderFlags = []
      ReadOnly = True
      Size = 135
    end
    object CadastroCPAIS: TSmallintField
      FieldName = 'CPAIS'
      Origin = '"VW_CAD_PRO_PSQ"."CPAIS"'
    end
    ...
    object CadastroXPAIS_ABREV: TIBStringField
      FieldName = 'XPAIS_ABREV'
      Origin = '"VW_CAD_PRO_PSQ"."XPAIS_ABREV"'
      Size = 30
    end
    ...
    object CadastroINFADCAD: TIBStringField
      FieldKind = fkInternalCalc
      FieldName = 'INFADCAD'
      Origin = '"VW_CAD_PRO_PSQ"."INFADCAD"'
      ProviderFlags = []
      ReadOnly = True
      Size = 812
    end
