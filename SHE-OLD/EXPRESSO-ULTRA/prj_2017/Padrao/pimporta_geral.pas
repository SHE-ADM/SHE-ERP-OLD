...
type
  Tfrmimporta_geral = class(Tfrmpadr3)
    ...
    imp_iteIDAK: TLargeintField;
    imp_iteIDEK: TLargeintField;
    imp_iteIDEP: TSmallintField;
    imp_iteIDPK: TLargeintField;
    imp_iteDTPK: TDateTimeField;
    imp_iteIDFK: TLargeintField;
    imp_iteDTFK: TDateTimeField;
    imp_iteCDRO: TLargeintField;
    imp_iteCDET: TLargeintField;
    imp_iteIDCP: TIntegerField;
    imp_iteIDSK: TLargeintField;
    imp_iteCF_VPRC_PAD_ORI: TIBStringField;
    imp_iteCF_VPRC_PAD: TFloatField;
    imp_iteVPRC_PAD_INI: TFloatField;
    imp_iteVPRC_PAD_FIM: TFloatField;
    imp_iteVPRC_PAD: TFloatField;
    imp_iteVPRC_COM: TFloatField;
    imp_itePDSC: TIBBCDField;
    imp_iteVDSC: TIBBCDField;
    imp_iteTSDE: TIBBCDField;
    imp_iteTCDE: TIBBCDField;
    imp_iteEST_QTDE: TIBBCDField;
    imp_iteEST_QTRL: TIntegerField;
    imp_iteQTDE: TIBBCDField;
    imp_iteQTRL: TIntegerField;
    imp_iteIDSP: TSmallintField;
    imp_iteCDSP: TLargeintField;
    imp_iteDTSP: TDateTimeField;
    imp_iteQTSP: TIBBCDField;
    imp_iteRLSP: TIntegerField;
    imp_iteNFCI: TIBStringField;
    imp_iteFLAG: TSmallintField;
    imp_iteUPRC_PAD: TIBBCDField;
    imp_iteIP: TIBStringField;
    imp_iteHOST: TIBStringField;
    imp_iteSEQUENCIA: TIntegerField;
    imp_iteITEM: TIntegerField;
    imp_iteIDEV: TLargeintField;
    imp_iteCDEV: TSmallintField;
...
//  nRecNo := bPSQProdutos(campo,cpro); { Ricardo }
  BRet   := (nRecNo >= 1);
  result := BRet;
end;
  ...
  repeat
    ...
    repeat
      ...
      begin
        ...
        begin
          SQL.Clear;
          SQL.Add('SELECT UCOM FROM TAB_UCOM');
          SQL.Add('WHERE  UCOM = '''+imp_nitNFE_UCOM.AsString+'''');
          Open;
          ...
          SQL.Clear;
          SQL.Add('SELECT UCOM FROM TAB_UCOM');
          SQL.Add('WHERE  UCOM = '''+imp_nitNFE_UTRIB.AsString+'''');
          Open;
          if Fields[0].IsNull then
          begin
            SQL.Clear;
