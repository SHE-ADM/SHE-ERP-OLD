...
uses
  ...
  Registry,StrInt, StrIntImp, IBEvents, rxSpeedbar, IBSQL;

type
  Tfrmrec_ban = class(Tfrmpadr1)
    ...
    fin_rec_car: TIBQuery;
    dtsfin_rec_car: TDataSource;
    fin_rec_carID: TIntegerField;
    fin_rec_carFIN_CCAB: TIntegerField;
    fin_rec_carFIN_CDBX: TIntegerField;
    fin_rec_carFIN_CDCX: TIntegerField;
    fin_rec_carFIN_CCLI: TIntegerField;
    fin_rec_carFIN_CVEN: TIntegerField;
    fin_rec_carFIN_CREP: TIntegerField;
    fin_rec_carFIN_PRAZ: TSmallintField;
    fin_rec_carFIN_ATRA: TSmallintField;
    fin_rec_carFIN_CONC: TSmallintField;
    fin_rec_carFIN_DCAD: TDateField;
    fin_rec_carFIN_DVEN: TDateField;
    fin_rec_carFIN_DPAG: TDateField;
    fin_rec_carFIN_DMED: TDateField;
    fin_rec_carFIN_DATR: TDateField;
    fin_rec_carFIN_STDO: TIBStringField;
    fin_rec_carFIN_DOCT: TIBStringField;
    fin_rec_carFIN_BANC: TIBStringField;
    fin_rec_carFIN_DBAN: TIBStringField;
    fin_rec_carFIN_AGEN: TIBStringField;
    fin_rec_carFIN_CONT: TIBStringField;
    fin_rec_carFIN_NCHQ: TIBStringField;
    fin_rec_carFIN_MCHQ: TSmallintField;
    fin_rec_carFIN_TIPO: TIBStringField;
    fin_rec_carFIN_STFI: TIBStringField;
    fin_rec_carFIN_STCO: TIBStringField;
    fin_rec_carFIN_VALO: TIBBCDField;
    fin_rec_carFIN_VPAG: TIBBCDField;
    fin_rec_carFIN_VPEN: TIBBCDField;
    fin_rec_carFIN_OBSE: TMemoField;
    fin_rec_carFIN_STA: TIBStringField;
    fin_rec_carFIN_DCAN: TDateField;
    fin_rec_carFIN_CPPL: TIntegerField;
    fin_rec_carFIN_CCUS: TIntegerField;
    fin_rec_carFIN_CBCO: TIntegerField;
    fin_rec_carFIN_PORT: TIBStringField;
    fin_rec_carFIN_VMUL: TIBBCDField;
    fin_rec_carFIN_PMUL: TIBBCDField;
    fin_rec_carFIN_VJUR: TIBBCDField;
    fin_rec_carFIN_PJUR: TIBBCDField;
    fin_rec_carFIN_VDES: TIBBCDField;
    fin_rec_carFIN_PDES: TIBBCDField;
    fin_rec_carFIN_DESC: TIBStringField;
    fin_rec_carFIN_CDCO: TIntegerField;
    fin_rec_carFIN_CDBA: TIBStringField;
    fin_rec_carFIN_DEBA: TIBStringField;
    pndir: TPanel;
    ...
    dbgdup: TdxDBGrid;
    nfe_dup: TIBQuery;
    dtsnfe_dup: TDataSource;
    nfe_dupID: TIntegerField;
    nfe_dupNFE_CDRO: TIntegerField;
    nfe_dupNFE_CCAB: TIntegerField;
    nfe_dupNFE_CFAV: TIntegerField;
    nfe_dupNFE_DROM: TDateField;
    nfe_dupNFE_CDNF: TIntegerField;
    nfe_dupNFE_DNFE: TDateField;
    nfe_dupNFE_TITU: TIBStringField;
    nfe_dupNFE_STPD: TIBStringField;
    nfe_dupNFE_STCO: TIBStringField;
    nfe_dupNFE_STFI: TIBStringField;
    nfe_dupNFE_PARC: TIntegerField;
    nfe_dupNFE_DVEN: TDateField;
    nfe_dupNFE_VDUP: TIBBCDField;
    nfe_dupNFE_DPAG: TDateField;
    nfe_dupNFE_VPAG: TIBBCDField;
    nfe_dupNFE_VPEN: TIBBCDField;
    nfe_dupNFE_OBSE: TMemoField;
    nfe_dupNFE_STA: TIBStringField;
    dbgdupNFE_TITU: TdxDBGridMaskColumn;
    dbgdupNFE_STFI: TdxDBGridMaskColumn;
    dbgdupNFE_DVEN: TdxDBGridDateColumn;
    dbgdupNFE_VDUP: TdxDBGridMaskColumn;
    dbgdupNFE_DPAG: TdxDBGridDateColumn;
    dbgdupNFE_VPAG: TdxDBGridMaskColumn;
    dbgdupNFE_VPEN: TdxDBGridMaskColumn;
    ...
    dbgConsultaFIN_IDBX: TdxDBGridMaskColumn;
  ...
  private
    ...
    function  RETORNA_TITU(doct: string): string;
  public
    { Public declarations }
    wRec: TBookMark;
  end;
...
uses uPrincipal, ppesquisa, prelatorio_geral, qcob_ped, parquivo_geral, qcob_rom;

{$R *.dfm}

procedure Tfrmrec_ban.abre_tabela;
begin
  with cadastro do
  begin
    DeleteSQL.Clear;
    DeleteSQL.Add('delete from '+SLPrincipal.Values['fin_rec_ban_bai']);
    DeleteSQL.Add('where');
    DeleteSQL.Add('ID = :OLD_ID');

    InsertSQL.Clear;
    InsertSQL.Add('insert into '+SLPrincipal.Values['fin_rec_ban_bai']);
    ...
    ModifySQL.Clear;
    ModifySQL.Add('update '+SLPrincipal.Values['fin_rec_ban_bai']);
    ModifySQL.Add('set');
...
function Tfrmrec_ban.RETORNA_TITU(doct: string): string;
var
  i: word;
  titu: string;
begin
  titu := '';
  for i := 1 to Length(doct) do
  begin
    if (copy(doct,i,1) = '-') or (copy(doct,i,1) = '.') or (copy(doct,i,1) = '/') then
       break;

    titu := titu + copy(doct,i,1);
  end;
  result := TRIM(titu);
end;

procedure Tfrmrec_ban.FormCreate(Sender: TObject);
begin
  RECDefault.Event := 'REC_BAN';
  ...
  begin
    Close;
    SelectSQL.Clear;
    SelectSQL.Add('SELECT   FIN_REC_BAN_BAI.*,CLI_FANT,CLI_RAZA,USU_DUSU,REP_FANT');
    SelectSQL.Add('FROM   '+SLPrincipal.Values['fin_rec_ban_bai']+' "FIN_REC_BAN_BAI"');
    SelectSQL.Add('LEFT     OUTER JOIN CAD_CLI ON FIN_REC_BAN_BAI.FIN_CCLI = CAD_CLI.ID');
    SelectSQL.Add('LEFT     OUTER JOIN CAD_REP ON FIN_REC_BAN_BAI.FIN_CREP = CAD_REP.ID');
    SelectSQL.Add('LEFT     OUTER JOIN CAD_USU ON FIN_REC_BAN_BAI.FIN_CVEN = CAD_USU.USU_CUSU');
    SelectSQL.Add('WHERE    FIN_REC_BAN_BAI.ID = 0');
    SelectSQL.Add('ORDER BY FIN_REC_BAN_BAI.FIN_DVEN');
  end;

  with fin_rec_car do
  begin
    SQL.Clear;
    SQL.Add('SELECT * FROM '+SLPrincipal.Values['fin_rec_car_bai']);
...
procedure Tfrmrec_ban.dtscadastroDataChange(Sender: TObject;
  Field: TField);
begin
  ...
  begin
    SQL.Clear;
    SQL.Add('SELECT * FROM '+SLPrincipal.Values['fin_rec_ban_rec']+' "FIN_REC_BAN_REC"');
  ...
  begin
    SQL.Clear;
    SQL.Add('SELECT * FROM '+SLPrincipal.Values['nfe_dup']+' "NFE_DUP"');
    if cadastroFIN_CDBX.AsInteger > 0 then
    SQL.Add('WHERE NFE_TITU LIKE '''+RETORNA_TITU(cadastroFIN_DOCT.AsString)+'%''')
    else
    SQL.Add('WHERE ID  = 0');
...
procedure Tfrmrec_ban.siPSQClick(Sender: TObject);
begin
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          begin
            SQL.Clear;
            SQL.Add('SELECT FIN_DOCT FROM '+SLPrincipal.Values['fin_rec_ban_rec']+' "FIN_REC_BAN_REC"');
...
procedure Tfrmrec_ban.dbgConsultaCustomDrawCell(Sender: TObject;
...
procedure Tfrmrec_ban.dbgcarCustomDrawCell(Sender: TObject;
  ACanvas: TCanvas; ARect: TRect; ANode: TdxTreeListNode;
  AColumn: TdxTreeListColumn; ASelected, AFocused, ANewItemRow: Boolean;
  var AText: String; var AColor: TColor; AFont: TFont;
  var AAlignment: TAlignment; var ADone: Boolean);
...
procedure Tfrmrec_ban.dbgdupCustomDrawCell(Sender: TObject;
  ACanvas: TCanvas; ARect: TRect; ANode: TdxTreeListNode;
  AColumn: TdxTreeListColumn; ASelected, AFocused, ANewItemRow: Boolean;
  var AText: String; var AColor: TColor; AFont: TFont;
  var AAlignment: TAlignment; var ADone: Boolean);
...
procedure Tfrmrec_ban.siRELClick(Sender: TObject);
begin
  ...
  try
    ...
    frmrelatorio_geral.cbFIN_REC_TREL.Tag   := 0;
    frmrelatorio_geral.cbFIN_REC_DATA.Text  := 'DATA VENCIMENTO';

    frmrelatorio_geral.cbFIN_REC_DCLI.Items.Add('TODOS');
    frmrelatorio_geral.cbFIN_REC_RCLI.Items.Add('TODOS');
    frmrelatorio_geral.cbFIN_REC_DVEN.Items.Add('TODOS');
    frmrelatorio_geral.cbFIN_REC_DREP.Items.Add('TODOS');
...
procedure Tfrmrec_ban.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  inherited;
...
procedure Tfrmrec_ban.siPEDClick(Sender: TObject);
var
  cdpd: string;
begin
...
procedure Tfrmrec_ban.VEN_PED_COBRANCA_COMBAIXA;
var
  i,p: word;
begin
  with consulta do
...
procedure Tfrmrec_ban.siVROMClick(Sender: TObject);
var
  cdro: string;
begin
  if cadastroID.IsNull then
...
procedure Tfrmrec_ban.ROM_CAB_ROMANEIO_COBRANCA_BANCARIO;
var
  i,p: word;
begin
  consulta.Last;
...
procedure Tfrmrec_ban.ROM_CAB_ROMANEIO_COBRANCA_COMBAIXA;
var
  i,p: word;
begin
  with consulta do
