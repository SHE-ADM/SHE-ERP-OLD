inherited frmcad_tra_edi: Tfrmcad_tra_edi
      ...
      object pcmain: TdxPageControl
        ...
        object tsBAN: TdxTabSheet
          ...
          object dbgban: TdxDBGrid
            ...
            object dbgbanTRA_DCAD: TdxDBGridDateColumn
              BandIndex = 0
              RowIndex = 0
              FieldName = 'TRA_DCAD'
            end
            object dbgbanTRA_BANC: TdxDBGridMaskColumn
              Width = 41
              BandIndex = 0
              RowIndex = 0
              FieldName = 'TRA_BANC'
            end
            object dbgbanTRA_DESC: TdxDBGridPickColumn
              Width = 246
              BandIndex = 0
              RowIndex = 0
              FieldName = 'TRA_DESC'
            end
            object dbgbanTRA_AGEN: TdxDBGridMaskColumn
              Width = 52
              BandIndex = 0
              RowIndex = 0
              FieldName = 'TRA_AGEN'
            end
            object dbgbanTRA_CONT: TdxDBGridMaskColumn
              Width = 79
              BandIndex = 0
              RowIndex = 0
              FieldName = 'TRA_CONT'
            end
            object dbgbanTRA_TIPO: TdxDBGridPickColumn
              Width = 125
              BandIndex = 0
              RowIndex = 0
              FieldName = 'TRA_TIPO'
            ...
            object dbgbanTRA_DOCU: TdxDBGridMaskColumn
              Width = 141
              BandIndex = 0
              RowIndex = 0
              FieldName = 'TRA_DOCU'
            end
            object dbgbanTRA_OBSE: TdxDBGridBlobColumn
              Width = 28
              BandIndex = 0
              RowIndex = 0
              FieldName = 'TRA_OBSE'
  ...
  object cad_tra_ban: TIBDataSet
    Database = dmDADOS.ibDB
    Transaction = IBTra
    AfterCancel = cad_tra_banAfterCancel
    AfterDelete = cad_tra_banAfterDelete
    AfterEdit = cad_tra_banAfterEdit
    AfterInsert = cad_tra_banAfterEdit
    AfterPost = cad_tra_banAfterPost
    BeforeCancel = cad_tra_banBeforeCancel
    BeforeDelete = cad_tra_banBeforeDelete
    OnNewRecord = cad_tra_banNewRecord
    DeleteSQL.Strings = (
      'delete from CAD_TRA_BAN'
      'where'
      '  ID = :OLD_ID')
    InsertSQL.Strings = (
      'insert into CAD_TRA_BAN'
      
        '  (ID, TRA_AGEN, TRA_BANC, TRA_CONT, TRA_CTRA, TRA_DCAD, TRA_DES' +
        'C, TRA_DOCU, '
      '   TRA_OBSE, TRA_TIPO)'
      'values'
      
        '  (:ID, :TRA_AGEN, :TRA_BANC, :TRA_CONT, :TRA_CTRA, :TRA_DCAD, :' +
        'TRA_DESC, '
      '   :TRA_DOCU, :TRA_OBSE, :TRA_TIPO)')
    RefreshSQL.Strings = (
      'Select '
      '  ID,'
      '  TRA_CTRA,'
    ...
    Left = 104
    Top = 8
    object cad_tra_banID: TIntegerField
      FieldName = 'ID'
      Origin = '"CAD_TRA_BAN"."ID"'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object cad_tra_banTRA_CTRA: TIntegerField
      FieldName = 'TRA_CTRA'
      Origin = '"CAD_TRA_BAN"."TRA_CTRA"'
    end
    object cad_tra_banTRA_DCAD: TDateField
      DisplayLabel = 'Data'
      FieldName = 'TRA_DCAD'
      Origin = '"CAD_TRA_BAN"."TRA_DCAD"'
    end
    object cad_tra_banTRA_BANC: TIBStringField
      DisplayLabel = 'Banco'
      FieldName = 'TRA_BANC'
      Origin = '"CAD_TRA_BAN"."TRA_BANC"'
      Size = 4
    end
    object cad_tra_banTRA_DESC: TIBStringField
      DisplayLabel = 'Descri'#231#227'o'
      FieldName = 'TRA_DESC'
      Origin = '"CAD_TRA_BAN"."TRA_DESC"'
      OnValidate = cad_tra_banTRA_DESCValidate
      Size = 50
    end
    object cad_tra_banTRA_AGEN: TIBStringField
      DisplayLabel = 'Agencia'
      FieldName = 'TRA_AGEN'
      Origin = '"CAD_TRA_BAN"."TRA_AGEN"'
      Size = 10
    end
    object cad_tra_banTRA_CONT: TIBStringField
      DisplayLabel = 'Conta'
      FieldName = 'TRA_CONT'
      Origin = '"CAD_TRA_BAN"."TRA_CONT"'
      Size = 15
    end
    object cad_tra_banTRA_OBSE: TMemoField
      DisplayLabel = 'Obs'
      FieldName = 'TRA_OBSE'
      Origin = '"CAD_TRA_BAN"."TRA_OBSE"'
      ProviderFlags = [pfInUpdate]
      BlobType = ftMemo
      Size = 8
    end
    object cad_tra_banTRA_TIPO: TIBStringField
      DisplayLabel = 'Tipo'
      FieldName = 'TRA_TIPO'
      Origin = '"CAD_TRA_BAN"."TRA_TIPO"'
    end
    object cad_tra_banTRA_DOCU: TIBStringField
      DisplayLabel = 'C.N.P.J. OU C.P.F.'
      FieldName = 'TRA_DOCU'
      Origin = '"CAD_TRA_BAN"."TRA_DOCU"'
    end
  end
  object dtscad_tra_ban: TDataSource
    DataSet = cad_tra_ban
    Left = 104
    Top = 40
  end
  object cad_tra_obs: TIBDataSet
    Database = dmDADOS.ibDB
    Transaction = IBTra
    AfterCancel = cad_tra_obsAfterCancel
    AfterDelete = cad_tra_obsAfterDelete
    AfterEdit = cad_tra_obsAfterEdit
    AfterInsert = cad_tra_obsAfterEdit
    AfterPost = cad_tra_obsAfterPost
    BeforeCancel = cad_tra_obsBeforeCancel
    BeforeDelete = cad_tra_obsBeforeDelete
    OnNewRecord = cad_tra_obsNewRecord
    DeleteSQL.Strings = (
      'delete from CAD_TRA_OBS'
      'where'
      '  ID = :OLD_ID')
    InsertSQL.Strings = (
      'insert into CAD_TRA_OBS'
      '  (ID, OBS_CTRA, OBS_DCAD, OBS_OBSE)'
      'values'
      '  (:ID, :OBS_CTRA, :OBS_DCAD, :OBS_OBSE)')
    RefreshSQL.Strings = (
      'Select '
    ...
    Left = 136
    Top = 8
    object cad_tra_obsID: TIntegerField
      FieldName = 'ID'
      Origin = '"CAD_TRA_OBS"."ID"'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object cad_tra_obsOBS_CTRA: TIntegerField
      FieldName = 'OBS_CTRA'
      Origin = '"CAD_TRA_OBS"."OBS_CTRA"'
    end
    object cad_tra_obsOBS_DCAD: TDateField
      FieldName = 'OBS_DCAD'
      Origin = '"CAD_TRA_OBS"."OBS_DCAD"'
    end
    object cad_tra_obsOBS_OBSE: TMemoField
      FieldName = 'OBS_OBSE'
      Origin = '"CAD_TRA_OBS"."OBS_OBSE"'
      ProviderFlags = [pfInUpdate]
      BlobType = ftMemo
      Size = 8
    end
  end
  object dtscad_tra_obs: TDataSource
    DataSet = cad_tra_obs
    Left = 136
    Top = 40
  end
