  ...
  object fin_rec: TIBDataSet
    ...
    InsertSQL.Strings = (
      'insert into FIN_REC'
        ...
        '  (CDEV, FIN_ATRA, FIN_CBCO, FIN_CCLI, FIN_CCUS, FIN_CDBX, FIN_C' +
        'DCX, FIN_CDNF, '
        ...
        '   FIN_VPAG, FIN_VPEN, FLAG, HOST, ID, IDEV, IP, RECO, SEQUENCIA' +
        ', TPCO)'
      'values'
      
        '  (:CDEV, :FIN_ATRA, :FIN_CBCO, :FIN_CCLI, :FIN_CCUS, :FIN_CDBX,' +
        ' :FIN_CDCX, '
      
        '   :FIN_CDNF, :FIN_CDPD, :FIN_CDRD, :FIN_CDRO, :FIN_COBR, :FIN_C' +
        'ONC, :FIN_CPF, '
      
        '   :FIN_CPPL, :FIN_CREP, :FIN_CTNR, :FIN_CVEN, :FIN_DATR, :FIN_D' +
        'BAI, :FIN_DCAD, '
      
        '   :FIN_DCLI, :FIN_DCUS, :FIN_DERD, :FIN_DMED, :FIN_DNFE, :FIN_D' +
        'OCT, :FIN_DPAG, '
      
        '   :FIN_DPPL, :FIN_DPRA, :FIN_DREP, :FIN_DROM, :FIN_DTCO, :FIN_D' +
        'TST, :FIN_DVEN, '
      
        '   :FIN_IPPL, :FIN_OBSE, :FIN_PCOM, :FIN_PDES, :FIN_PJUR, :FIN_P' +
        'MUL, :FIN_PORT, '
      
        '   :FIN_PRAZ, :FIN_RCLI, :FIN_RREP, :FIN_STA, :FIN_STCO, :FIN_ST' +
        'DO, :FIN_STFI, '
      
        '   :FIN_STPD, :FIN_VALO, :FIN_VCHQ, :FIN_VDES, :FIN_VENC, :FIN_V' +
        'END, :FIN_VJUR, '
      
        '   :FIN_VMUL, :FIN_VPAG, :FIN_VPEN, :FLAG, :HOST, :ID, :IDEV, :I' +
        'P, :RECO, '
      '   :SEQUENCIA, :TPCO)')
    RefreshSQL.Strings = (
      'Select '
    ...
    object fin_recIP: TIBStringField
      FieldName = 'IP'
      Origin = '"FIN_REC"."IP"'
    end
    object fin_recHOST: TIBStringField
      FieldName = 'HOST'
      Origin = '"FIN_REC"."HOST"'
      Size = 30
    end
    object fin_recSEQUENCIA: TIntegerField
      FieldName = 'SEQUENCIA'
      Origin = '"FIN_REC"."SEQUENCIA"'
    end
    object fin_recFLAG: TSmallintField
      FieldName = 'FLAG'
      Origin = '"FIN_REC"."FLAG"'
    end
    object fin_recIDEV: TLargeintField
      FieldName = 'IDEV'
      Origin = '"FIN_REC"."IDEV"'
    end
    object fin_recCDEV: TSmallintField
      FieldName = 'CDEV'
      Origin = '"FIN_REC"."CDEV"'
    end
  ...
  object fin_rec_bai: TIBDataSet
    ...
    InsertSQL.Strings = (
      'insert into FIN_REC_BAI'
        ...
        '  (CDEV, FIN_AGEN, FIN_ATRA, FIN_BANC, FIN_CCAB, FIN_CCLI, FIN_C' +
        'CUS, FIN_CDBA, '
        ...
        'IN_VPEN, '
      '   FLAG, HOST, ID, IDEV, IP, RECO, SEQUENCIA, TPCO)'
      'values'
      
        '  (:CDEV, :FIN_AGEN, :FIN_ATRA, :FIN_BANC, :FIN_CCAB, :FIN_CCLI,' +
        ' :FIN_CCUS, '
      
        '   :FIN_CDBA, :FIN_CDBX, :FIN_CDCO, :FIN_CDCX, :FIN_CDRD, :FIN_C' +
        'OBR, :FIN_CONC, '
      
        '   :FIN_CONT, :FIN_CPF, :FIN_CPPL, :FIN_CREP, :FIN_CTNR, :FIN_CV' +
        'EN, :FIN_DATR, '
      
        '   :FIN_DBAI, :FIN_DBAN, :FIN_DCAD, :FIN_DCLI, :FIN_DEBA, :FIN_D' +
        'ERD, :FIN_DFIN, '
      
        '   :FIN_DMED, :FIN_DOCT, :FIN_DPAG, :FIN_DREP, :FIN_DTST, :FIN_D' +
        'VEN, :FIN_MCHQ, '
      
        '   :FIN_NCHQ, :FIN_OBSE, :FIN_PDES, :FIN_PJUR, :FIN_PMUL, :FIN_P' +
        'RAZ, :FIN_RCLI, '
      
        '   :FIN_RREP, :FIN_STA, :FIN_STCO, :FIN_STDO, :FIN_STFI, :FIN_TI' +
        'PO, :FIN_VALO, '
      
        '   :FIN_VCHQ, :FIN_VDES, :FIN_VENC, :FIN_VEND, :FIN_VJUR, :FIN_V' +
        'MUL, :FIN_VPAG, '
      
        '   :FIN_VPEN, :FLAG, :HOST, :ID, :IDEV, :IP, :RECO, :SEQUENCIA, ' +
        ':TPCO)')
    RefreshSQL.Strings = (
      'Select '
      '  ID,'
    ...
    object fin_rec_baiIP: TIBStringField
      FieldName = 'IP'
      Origin = '"FIN_REC_BAI"."IP"'
    end
    object fin_rec_baiHOST: TIBStringField
      FieldName = 'HOST'
      Origin = '"FIN_REC_BAI"."HOST"'
      Size = 30
    end
    object fin_rec_baiIDEV: TLargeintField
      FieldName = 'IDEV'
      Origin = '"FIN_REC_BAI"."IDEV"'
    end
    object fin_rec_baiCDEV: TSmallintField
      FieldName = 'CDEV'
      Origin = '"FIN_REC_BAI"."CDEV"'
    end
    object fin_rec_baiSEQUENCIA: TIntegerField
      FieldName = 'SEQUENCIA'
      Origin = '"FIN_REC_BAI"."SEQUENCIA"'
    end
    object fin_rec_baiFLAG: TSmallintField
      FieldName = 'FLAG'
      Origin = '"FIN_REC_BAI"."FLAG"'
    end
  end
