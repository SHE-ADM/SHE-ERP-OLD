...
begin
  dbgaviGRD_PREC.DisableEditor := (NOT frmprincipal.ACESSO(RECUsuarios.ID,'USU_EDIT','Produtos','Cadastro','Preço de Venda Normal',false));
  dbgaviGRD_VPRC.DisableEditor := (NOT frmprincipal.ACESSO(RECUsuarios.ID,'USU_EDIT','Produtos','Cadastro','Preço de Venda Normal',false));
  dbgaviGRD_RPRC.DisableEditor := (NOT frmprincipal.ACESSO(RECUsuarios.ID,'USU_EDIT','Produtos','Cadastro','Preço de Venda Normal',false));


  ladfor.Visible := frmprincipal.ACESSO(RECUsuarios.ID,'USU_VISU','Fornecedores','Cadastro','Permissões Gerais',false);
  cbdfor.Visible := ladfor.Visible;
  
  gbfoto.Enabled := frmprincipal.ACESSO(RECUsuarios.ID,'USU_EDIT','Produtos','Cadastro','Foto de Catálogo',false);
  edprec.Enabled := frmprincipal.ACESSO(RECUsuarios.ID,'USU_EDIT','Produtos','Cadastro','Preço de Venda Normal'  ,false);
  edvprc.Enabled := edprec.Enabled;
  edsprc.Enabled := edprec.Enabled;
  edrprc.Enabled := edprec.Enabled;
  edppro.Enabled := frmprincipal.ACESSO(RECUsuarios.ID,'USU_EDIT','Produtos','Cadastro','Preço de Venda Promoção',false);
  edvpro.Enabled := edppro.Enabled;
  edspro.Enabled := edppro.Enabled;
  edrpro.Enabled := edppro.Enabled;
  edpdsc.Enabled := frmprincipal.ACESSO(RECUsuarios.ID,'USU_EDIT','Produtos','Cadastro','Desconto'               ,false);
  ...
  tscomp.Enabled := frmprincipal.ACESSO(RECUsuarios.ID,'USU_EDIT','Produtos','Cadastro','Composição',false);
  edpcom.Enabled := frmprincipal.ACESSO(RECUsuarios.ID,'USU_EDIT','Produtos','Cadastro','Preço de Compra',false);
  edcust.Enabled := frmprincipal.ACESSO(RECUsuarios.ID,'USU_EDIT','Produtos','Cadastro','Preço de Custo',false);
  edclib.Enabled := frmprincipal.ACESSO(RECUsuarios.ID,'USU_EDIT','Produtos','Cadastro','Preço de Custo',false);
  rgcont.Enabled := frmprincipal.ACESSO(RECUsuarios.ID,'USU_EDIT','Produtos','Cadastro','Contábil',false);
...
begin
  ...
  begin
    ...
    begin
      if not frmprincipal.ACESSO(RECUsuarios.ID,'USU_EDIT','Produtos','Cadastro','Permissões Gerais',false) then
    ...
    try
      ...
      begin
        ...
        begin
          ...
          RECDefault.ID := IntToStr(consulta.Tag);
          RECDefault.CD := CAD_PRO_GRDGRD_CPRO.AsString;

          ibSP.ParamByName('CBAR').Value := oBarCode(RECDefault);
      ...
      begin
        ...
        RECDefault.ID := edid.Text;
        RECDefault.CD := edcart.Text;
...
//Ricardo    SQL.Add('WHERE    PRO_CPRO = '''+frmcad_pro.cadastroPRO_CPRO.AsString+'''');
//    SQL.Add('AND      PRO_STA = '''+inttostr(frmcad_pro.dbgConsulta.Tag)+'''');
  ...
  begin
    if cad_proID.AsInteger = frmcad_pro.cadastroIDCP.AsInteger then
       break;
    cad_pro.Next;
  end;
...
begin
  ...
  begin
    ...
    edcart.Text    := frmcad_pro.cadastroARTIGO.AsString;
    ALTERA_REFERENCIA;
  end else
  NOVA_REFERENCIA;
end;
