inherited frmcad_com_edi: Tfrmcad_com_edi
  Left = 406
  Top = 22
  ClientHeight = 564
  ClientWidth = 542
      ...
      object pcmain: TdxPageControl
        ...
        object tsBAN: TdxTabSheet
          ...
          object dbgban: TdxDBGrid
            ...
            object dbgbanCOM_DCAD: TdxDBGridDateColumn
              BandIndex = 0
              RowIndex = 0
              FieldName = 'COM_DCAD'
            end
            object dbgbanCOM_BANC: TdxDBGridMaskColumn
              Width = 41
              BandIndex = 0
              RowIndex = 0
              FieldName = 'COM_BANC'
            end
            object dbgbanCOM_DESC: TdxDBGridPickColumn
              Width = 246
              BandIndex = 0
              RowIndex = 0
              FieldName = 'COM_DESC'
            end
            object dbgbanCOM_AGEN: TdxDBGridMaskColumn
              Width = 52
              BandIndex = 0
              RowIndex = 0
              FieldName = 'COM_AGEN'
            end
            object dbgbanCOM_CONT: TdxDBGridMaskColumn
              Width = 79
              BandIndex = 0
              RowIndex = 0
              FieldName = 'COM_CONT'
            end
            object dbgbanCOM_TIPO: TdxDBGridPickColumn
              Width = 125
              BandIndex = 0
              RowIndex = 0
              FieldName = 'COM_TIPO'
            ...
            object dbgbanCOM_DOCU: TdxDBGridMaskColumn
              Width = 141
              BandIndex = 0
              RowIndex = 0
              FieldName = 'COM_DOCU'
            end
            object dbgbanCOM_OBSE: TdxDBGridBlobColumn
              Width = 28
              BandIndex = 0
              RowIndex = 0
              FieldName = 'COM_OBSE'
  ...
  object cad_com_ban: TIBDataSet
    Database = dmDADOS.ibDB
    Transaction = IBTra
    AfterCancel = cad_com_banAfterCancel
    AfterDelete = cad_com_banAfterDelete
    AfterEdit = cad_com_banAfterEdit
    AfterInsert = cad_com_banAfterEdit
    AfterPost = cad_com_banAfterPost
    BeforeCancel = cad_com_banBeforeCancel
    BeforeDelete = cad_com_banBeforeDelete
    OnNewRecord = cad_com_banNewRecord
    DeleteSQL.Strings = (
      'delete from CAD_COM_BAN'
      'where'
      '  ID = :OLD_ID')
    InsertSQL.Strings = (
      'insert into CAD_COM_BAN'
      
        '  (COM_AGEN, COM_BANC, COM_CCOM, COM_CONT, COM_DCAD, COM_DESC, C' +
        'OM_DOCU, '
      '   COM_OBSE, COM_TIPO, ID)'
      'values'
      
        '  (:COM_AGEN, :COM_BANC, :COM_CCOM, :COM_CONT, :COM_DCAD, :COM_D' +
        'ESC, :COM_DOCU, '
      '   :COM_OBSE, :COM_TIPO, :ID)')
    RefreshSQL.Strings = (
      'Select '
    ...
    Left = 104
    Top = 8
    object cad_com_banCOM_CCOM: TIntegerField
      FieldName = 'COM_CCOM'
      Origin = '"CAD_COM_BAN"."COM_CCOM"'
    end
    object cad_com_banCOM_DCAD: TDateField
      DisplayLabel = 'Data'
      FieldName = 'COM_DCAD'
      Origin = '"CAD_COM_BAN"."COM_DCAD"'
    end
    object cad_com_banCOM_BANC: TIBStringField
      DisplayLabel = 'Banco'
      FieldName = 'COM_BANC'
      Origin = '"CAD_COM_BAN"."COM_BANC"'
      Size = 4
    end
    object cad_com_banCOM_DESC: TIBStringField
      DisplayLabel = 'Descri'#231#227'o'
      FieldName = 'COM_DESC'
      Origin = '"CAD_COM_BAN"."COM_DESC"'
      OnValidate = cad_com_banCOM_DESCValidate
      Size = 50
    end
    object cad_com_banCOM_AGEN: TIBStringField
      DisplayLabel = 'Agencia'
      FieldName = 'COM_AGEN'
      Origin = '"CAD_COM_BAN"."COM_AGEN"'
      Size = 10
    end
    object cad_com_banCOM_CONT: TIBStringField
      DisplayLabel = 'Conta'
      FieldName = 'COM_CONT'
      Origin = '"CAD_COM_BAN"."COM_CONT"'
      Size = 15
    end
    object cad_com_banCOM_OBSE: TMemoField
      DisplayLabel = 'Obs'
      FieldName = 'COM_OBSE'
      Origin = '"CAD_COM_BAN"."COM_OBSE"'
      ProviderFlags = [pfInUpdate]
      BlobType = ftMemo
      Size = 8
    end
    object cad_com_banCOM_TIPO: TIBStringField
      DisplayLabel = 'Tipo'
      FieldName = 'COM_TIPO'
      Origin = '"CAD_COM_BAN"."COM_TIPO"'
    end
    object cad_com_banCOM_DOCU: TIBStringField
      DisplayLabel = 'C.N.P.J. ou C.P.F.'
      FieldName = 'COM_DOCU'
      Origin = '"CAD_COM_BAN"."COM_DOCU"'
    end
    object cad_com_banID: TIntegerField
      FieldName = 'ID'
      Origin = '"CAD_FOR_BAN"."ID"'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
  end
  object dtscad_com_ban: TDataSource
    DataSet = cad_com_ban
    Left = 104
    Top = 40
  end
  object cad_com_obs: TIBDataSet
    Database = dmDADOS.ibDB
    Transaction = IBTra
    AfterCancel = cad_com_obsAfterCancel
    AfterDelete = cad_com_obsAfterDelete
    AfterEdit = cad_com_obsAfterEdit
    AfterInsert = cad_com_obsAfterEdit
    AfterPost = cad_com_obsAfterPost
    BeforeCancel = cad_com_obsBeforeCancel
    BeforeDelete = cad_com_obsBeforeDelete
    OnNewRecord = cad_com_obsNewRecord
    DeleteSQL.Strings = (
      'delete from CAD_COM_OBS'
      'where'
      '  ID = :OLD_ID')
    InsertSQL.Strings = (
      'insert into CAD_COM_OBS'
      '  (ID, OBS_CCOM, OBS_DCAD, OBS_OBSE)'
      'values'
      '  (:ID, :OBS_CCOM, :OBS_DCAD, :OBS_OBSE)')
    RefreshSQL.Strings = (
      'Select '
    ...
    Left = 136
    Top = 8
    object cad_com_obsID: TIntegerField
      FieldName = 'ID'
      Origin = '"CAD_COM_OBS"."ID"'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object cad_com_obsOBS_CCOM: TIntegerField
      FieldName = 'OBS_CCOM'
      Origin = '"CAD_COM_OBS"."OBS_CCOM"'
    end
    object cad_com_obsOBS_DCAD: TDateField
      DisplayLabel = 'Data'
      FieldName = 'OBS_DCAD'
      Origin = '"CAD_COM_OBS"."OBS_DCAD"'
    end
    object cad_com_obsOBS_OBSE: TMemoField
      DisplayLabel = 'Obs'
      FieldName = 'OBS_OBSE'
      Origin = '"CAD_COM_OBS"."OBS_OBSE"'
      ProviderFlags = [pfInUpdate]
      BlobType = ftMemo
      Size = 8
    end
  end
  object dtscad_com_obs: TDataSource
    DataSet = cad_com_obs
    Left = 136
    Top = 40
  end
  ...
  object cad_com: TIBDataSet
    ...
    InsertSQL.Strings = (
      'insert into CAD_COM'
        ...
        '  (COM_BAI, COM_BAIC, COM_BAIV, COM_CCEL, COM_CCM, COM_CCON, COM' +
        '_CDD2, '
      
        '   COM_CDD3, COM_CDD4, COM_CDD5, COM_CDD6, COM_CDDD, COM_CEL, CO' +
        'M_CEP, '
      
        '   COM_CEPC, COM_CEPV, COM_CFAX, COM_CICM, COM_CID, COM_CIDC, CO' +
        'M_CIDV, '
      
        '   COM_CMAI, COM_CMUC, COM_CMUN, COM_CMUV, COM_CNCE, COM_CNID, C' +
        'OM_CNPJ, '
      
        '   COM_COMC, COM_COMP, COM_COMV, COM_CONT, COM_CPAG, COM_CPF, CO' +
        'M_CRED, '
      
        '   COM_CTC1, COM_CTC2, COM_CTE1, COM_CTE2, COM_CTE3, COM_CTRA, C' +
        'OM_DALT, '
      
        '   COM_DCAD, COM_DD2, COM_DD3, COM_DD4, COM_DD5, COM_DD6, COM_DD' +
        'D, COM_DFUN, '
      
        '   COM_DPAG, COM_DTRA, COM_ESTA, COM_ESTC, COM_ESTV, COM_FANT, C' +
        'OM_FAX, '
      
        '   COM_FCEL, COM_FCON, COM_FDD2, COM_FDD3, COM_FDD4, COM_FDD5, C' +
        'OM_FDD6, '
      
        '   COM_FDDD, COM_FFAX, COM_FMAI, COM_FNCE, COM_FNID, COM_FTC1, C' +
        'OM_FTC2, '
      
        '   COM_FTE1, COM_FTE2, COM_FTE3, COM_IMUN, COM_INSC, COM_LOGC, C' +
        'OM_LOGR, '
      
        '   COM_LOGV, COM_MAIL, COM_NCEL, COM_NEID, COM_NUMC, COM_NUME, C' +
        'OM_NUMV, '
      
        '   COM_OBSE, COM_OBSO, COM_RAMO, COM_RAZA, COM_REVE, COM_RG, COM' +
        '_RICM, '
      
        '   COM_SITE, COM_STA, COM_STAV, COM_TCE1, COM_TCE2, COM_TEL1, CO' +
        'M_TEL2, '
      
        '   COM_TEL3, COM_TLOC, COM_TLOG, COM_TLOV, COM_TPVE, COM_VDSC, C' +
        'OM_VULT, '
      '   ID)'
      'values'
      
        '  (:COM_BAI, :COM_BAIC, :COM_BAIV, :COM_CCEL, :COM_CCM, :COM_CCO' +
        'N, :COM_CDD2, '
      
        '   :COM_CDD3, :COM_CDD4, :COM_CDD5, :COM_CDD6, :COM_CDDD, :COM_C' +
        'EL, :COM_CEP, '
      
        '   :COM_CEPC, :COM_CEPV, :COM_CFAX, :COM_CICM, :COM_CID, :COM_CI' +
        'DC, :COM_CIDV, '
      
        '   :COM_CMAI, :COM_CMUC, :COM_CMUN, :COM_CMUV, :COM_CNCE, :COM_C' +
        'NID, :COM_CNPJ, '
      
        '   :COM_COMC, :COM_COMP, :COM_COMV, :COM_CONT, :COM_CPAG, :COM_C' +
        'PF, :COM_CRED, '
      
        '   :COM_CTC1, :COM_CTC2, :COM_CTE1, :COM_CTE2, :COM_CTE3, :COM_C' +
        'TRA, :COM_DALT, '
      
        '   :COM_DCAD, :COM_DD2, :COM_DD3, :COM_DD4, :COM_DD5, :COM_DD6, ' +
        ':COM_DDD, '
      
        '   :COM_DFUN, :COM_DPAG, :COM_DTRA, :COM_ESTA, :COM_ESTC, :COM_E' +
        'STV, :COM_FANT, '
      
        '   :COM_FAX, :COM_FCEL, :COM_FCON, :COM_FDD2, :COM_FDD3, :COM_FD' +
        'D4, :COM_FDD5, '
      
        '   :COM_FDD6, :COM_FDDD, :COM_FFAX, :COM_FMAI, :COM_FNCE, :COM_F' +
        'NID, :COM_FTC1, '
      
        '   :COM_FTC2, :COM_FTE1, :COM_FTE2, :COM_FTE3, :COM_IMUN, :COM_I' +
        'NSC, :COM_LOGC, '
      
        '   :COM_LOGR, :COM_LOGV, :COM_MAIL, :COM_NCEL, :COM_NEID, :COM_N' +
        'UMC, :COM_NUME, '
      
        '   :COM_NUMV, :COM_OBSE, :COM_OBSO, :COM_RAMO, :COM_RAZA, :COM_R' +
        'EVE, :COM_RG, '
      
        '   :COM_RICM, :COM_SITE, :COM_STA, :COM_STAV, :COM_TCE1, :COM_TC' +
        'E2, :COM_TEL1, '
      
        '   :COM_TEL2, :COM_TEL3, :COM_TLOC, :COM_TLOG, :COM_TLOV, :COM_T' +
        'PVE, :COM_VDSC, '
      '   :COM_VULT, :ID)')
    RefreshSQL.Strings = (
      'Select '
    ...
    Left = 168
    Top = 40
    object cad_comID: TIntegerField
      FieldName = 'ID'
      Origin = '"CAD_COM"."ID"'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object cad_comCOM_RAZA: TIBStringField
      FieldName = 'COM_RAZA'
      Origin = '"CAD_COM"."COM_RAZA"'
      Size = 60
    end
    object cad_comCOM_FANT: TIBStringField
      FieldName = 'COM_FANT'
      Origin = '"CAD_COM"."COM_FANT"'
      Size = 40
    end
    object cad_comCOM_CONT: TIBStringField
      FieldName = 'COM_CONT'
      Origin = '"CAD_COM"."COM_CONT"'
      Size = 30
    end
    object cad_comCOM_DCAD: TDateField
      FieldName = 'COM_DCAD'
      Origin = '"CAD_COM"."COM_DCAD"'
    end
    object cad_comCOM_STA: TIBStringField
      FieldName = 'COM_STA'
      Origin = '"CAD_COM"."COM_STA"'
      FixedChar = True
      Size = 1
    end
    object cad_comCOM_MAIL: TIBStringField
      FieldName = 'COM_MAIL'
      Origin = '"CAD_COM"."COM_MAIL"'
      Size = 60
    end
    object cad_comCOM_DDD: TIBStringField
      FieldName = 'COM_DDD'
      Origin = '"CAD_COM"."COM_DDD"'
      Size = 2
    end
    object cad_comCOM_TEL1: TIBStringField
      FieldName = 'COM_TEL1'
      Origin = '"CAD_COM"."COM_TEL1"'
      Size = 9
    end
    object cad_comCOM_TEL2: TIBStringField
      FieldName = 'COM_TEL2'
      Origin = '"CAD_COM"."COM_TEL2"'
      Size = 9
    end
    object cad_comCOM_FAX: TIBStringField
      FieldName = 'COM_FAX'
      Origin = '"CAD_COM"."COM_FAX"'
      Size = 9
    end
    object cad_comCOM_CEL: TIBStringField
      FieldName = 'COM_CEL'
      Origin = '"CAD_COM"."COM_CEL"'
      Size = 9
    end
    object cad_comCOM_RG: TIBStringField
      FieldName = 'COM_RG'
      Origin = '"CAD_COM"."COM_RG"'
      Size = 15
    end
    object cad_comCOM_CPF: TIBStringField
      FieldName = 'COM_CPF'
      Origin = '"CAD_COM"."COM_CPF"'
      Size = 11
    end
    object cad_comCOM_INSC: TIBStringField
      FieldName = 'COM_INSC'
      Origin = '"CAD_COM"."COM_INSC"'
    end
    object cad_comCOM_CNPJ: TIBStringField
      FieldName = 'COM_CNPJ'
      Origin = '"CAD_COM"."COM_CNPJ"'
      Size = 14
    end
    object cad_comCOM_TLOG: TIBStringField
      FieldName = 'COM_TLOG'
      Origin = '"CAD_COM"."COM_TLOG"'
      Size = 15
    end
    object cad_comCOM_LOGR: TIBStringField
      FieldName = 'COM_LOGR'
      Origin = '"CAD_COM"."COM_LOGR"'
      Size = 60
    end
    object cad_comCOM_CEP: TIBStringField
      FieldName = 'COM_CEP'
      Origin = '"CAD_COM"."COM_CEP"'
      Size = 9
    end
    object cad_comCOM_NUME: TIBStringField
      FieldName = 'COM_NUME'
      Origin = '"CAD_COM"."COM_NUME"'
      Size = 10
    end
    object cad_comCOM_COMP: TIBStringField
      FieldName = 'COM_COMP'
      Origin = '"CAD_COM"."COM_COMP"'
      Size = 40
    end
    object cad_comCOM_BAI: TIBStringField
      FieldName = 'COM_BAI'
      Origin = '"CAD_COM"."COM_BAI"'
      Size = 40
    end
    object cad_comCOM_CID: TIBStringField
      FieldName = 'COM_CID'
      Origin = '"CAD_COM"."COM_CID"'
      Size = 40
    end
    object cad_comCOM_ESTA: TIBStringField
      FieldName = 'COM_ESTA'
      Origin = '"CAD_COM"."COM_ESTA"'
      Size = 2
    end
    object cad_comCOM_TLOC: TIBStringField
      FieldName = 'COM_TLOC'
      Origin = '"CAD_COM"."COM_TLOC"'
      Size = 15
    end
    object cad_comCOM_LOGC: TIBStringField
      FieldName = 'COM_LOGC'
      Origin = '"CAD_COM"."COM_LOGC"'
      Size = 60
    end
    object cad_comCOM_CEPC: TIBStringField
      FieldName = 'COM_CEPC'
      Origin = '"CAD_COM"."COM_CEPC"'
      Size = 9
    end
    object cad_comCOM_NUMC: TIBStringField
      FieldName = 'COM_NUMC'
      Origin = '"CAD_COM"."COM_NUMC"'
      Size = 10
    end
    object cad_comCOM_COMC: TIBStringField
      FieldName = 'COM_COMC'
      Origin = '"CAD_COM"."COM_COMC"'
      Size = 40
    end
    object cad_comCOM_BAIC: TIBStringField
      FieldName = 'COM_BAIC'
      Origin = '"CAD_COM"."COM_BAIC"'
      Size = 40
    end
    object cad_comCOM_CIDC: TIBStringField
      FieldName = 'COM_CIDC'
      Origin = '"CAD_COM"."COM_CIDC"'
      Size = 40
    end
    object cad_comCOM_ESTC: TIBStringField
      FieldName = 'COM_ESTC'
      Origin = '"CAD_COM"."COM_ESTC"'
      Size = 2
    end
    object cad_comCOM_OBSO: TMemoField
      FieldName = 'COM_OBSO'
      Origin = '"CAD_COM"."COM_OBSO"'
      ProviderFlags = [pfInUpdate]
      BlobType = ftMemo
      Size = 8
    end
    object cad_comCOM_STAV: TIBStringField
      FieldName = 'COM_STAV'
      Origin = '"CAD_COM"."COM_STAV"'
      FixedChar = True
      Size = 1
    end
    object cad_comCOM_VULT: TIBBCDField
      FieldName = 'COM_VULT'
      Origin = '"CAD_COM"."COM_VULT"'
      Precision = 9
      Size = 2
    end
    object cad_comCOM_TPVE: TIBStringField
      FieldName = 'COM_TPVE'
      Origin = '"CAD_COM"."COM_TPVE"'
      Size = 10
    end
    object cad_comCOM_OBSE: TMemoField
      FieldName = 'COM_OBSE'
      Origin = '"CAD_COM"."COM_OBSE"'
      ProviderFlags = [pfInUpdate]
      BlobType = ftMemo
      Size = 8
    end
    object cad_comCOM_TLOV: TIBStringField
      FieldName = 'COM_TLOV'
      Origin = '"CAD_COM"."COM_TLOV"'
      Size = 15
    end
    object cad_comCOM_LOGV: TIBStringField
      FieldName = 'COM_LOGV'
      Origin = '"CAD_COM"."COM_LOGV"'
      Size = 60
    end
    object cad_comCOM_CEPV: TIBStringField
      FieldName = 'COM_CEPV'
      Origin = '"CAD_COM"."COM_CEPV"'
      Size = 9
    end
    object cad_comCOM_NUMV: TIBStringField
      FieldName = 'COM_NUMV'
      Origin = '"CAD_COM"."COM_NUMV"'
      Size = 10
    end
    object cad_comCOM_COMV: TIBStringField
      FieldName = 'COM_COMV'
      Origin = '"CAD_COM"."COM_COMV"'
      Size = 40
    end
    object cad_comCOM_BAIV: TIBStringField
      FieldName = 'COM_BAIV'
      Origin = '"CAD_COM"."COM_BAIV"'
      Size = 40
    end
    object cad_comCOM_CIDV: TIBStringField
      FieldName = 'COM_CIDV'
      Origin = '"CAD_COM"."COM_CIDV"'
      Size = 40
    end
    object cad_comCOM_ESTV: TIBStringField
      FieldName = 'COM_ESTV'
      Origin = '"CAD_COM"."COM_ESTV"'
      Size = 2
    end
    object cad_comCOM_RICM: TIBStringField
      FieldName = 'COM_RICM'
      Origin = '"CAD_COM"."COM_RICM"'
      FixedChar = True
      Size = 1
    end
    object cad_comCOM_CPAG: TIBStringField
      FieldName = 'COM_CPAG'
      Origin = '"CAD_COM"."COM_CPAG"'
      Size = 2
    end
    object cad_comCOM_DPAG: TIBStringField
      FieldName = 'COM_DPAG'
      Origin = '"CAD_COM"."COM_DPAG"'
      Size = 50
    end
    object cad_comCOM_CMUN: TIBStringField
      FieldName = 'COM_CMUN'
      Origin = '"CAD_COM"."COM_CMUN"'
      Size = 10
    end
    object cad_comCOM_DALT: TDateField
      FieldName = 'COM_DALT'
      Origin = '"CAD_COM"."COM_DALT"'
    end
    object cad_comCOM_CTRA: TIntegerField
      FieldName = 'COM_CTRA'
      Origin = '"CAD_COM"."COM_CTRA"'
    end
    object cad_comCOM_DTRA: TIBStringField
      FieldName = 'COM_DTRA'
      Origin = '"CAD_COM"."COM_DTRA"'
    end
    object cad_comCOM_DFUN: TDateField
      FieldName = 'COM_DFUN'
      Origin = '"CAD_COM"."COM_DFUN"'
    end
    object cad_comCOM_CICM: TIBStringField
      FieldName = 'COM_CICM'
      Origin = '"CAD_COM"."COM_CICM"'
      FixedChar = True
      Size = 1
    end
    object cad_comCOM_RAMO: TIBStringField
      FieldName = 'COM_RAMO'
      Origin = '"CAD_COM"."COM_RAMO"'
      Size = 120
    end
    object cad_comCOM_CMUV: TIBStringField
      FieldName = 'COM_CMUV'
      Origin = '"CAD_COM"."COM_CMUV"'
      Size = 10
    end
    object cad_comCOM_CMUC: TIBStringField
      FieldName = 'COM_CMUC'
      Origin = '"CAD_COM"."COM_CMUC"'
      Size = 10
    end
    object cad_comCOM_DD2: TIBStringField
      FieldName = 'COM_DD2'
      Origin = '"CAD_COM"."COM_DD2"'
      Size = 2
    end
    object cad_comCOM_DD3: TIBStringField
      FieldName = 'COM_DD3'
      Origin = '"CAD_COM"."COM_DD3"'
      Size = 2
    end
    object cad_comCOM_DD4: TIBStringField
      FieldName = 'COM_DD4'
      Origin = '"CAD_COM"."COM_DD4"'
      Size = 2
    end
    object cad_comCOM_DD5: TIBStringField
      FieldName = 'COM_DD5'
      Origin = '"CAD_COM"."COM_DD5"'
      Size = 2
    end
    object cad_comCOM_DD6: TIBStringField
      FieldName = 'COM_DD6'
      Origin = '"CAD_COM"."COM_DD6"'
      Size = 2
    end
    object cad_comCOM_TEL3: TIBStringField
      FieldName = 'COM_TEL3'
      Origin = '"CAD_COM"."COM_TEL3"'
      Size = 9
    end
    object cad_comCOM_TCE1: TIBStringField
      FieldName = 'COM_TCE1'
      Origin = '"CAD_COM"."COM_TCE1"'
      Size = 10
    end
    object cad_comCOM_TCE2: TIBStringField
      FieldName = 'COM_TCE2'
      Origin = '"CAD_COM"."COM_TCE2"'
      Size = 10
    end
    object cad_comCOM_NCEL: TIBStringField
      FieldName = 'COM_NCEL'
      Origin = '"CAD_COM"."COM_NCEL"'
      Size = 9
    end
    object cad_comCOM_NEID: TIBStringField
      FieldName = 'COM_NEID'
      Origin = '"CAD_COM"."COM_NEID"'
      Size = 15
    end
    object cad_comCOM_FCON: TIBStringField
      FieldName = 'COM_FCON'
      Origin = '"CAD_COM"."COM_FCON"'
      Size = 30
    end
    object cad_comCOM_FMAI: TIBStringField
      FieldName = 'COM_FMAI'
      Origin = '"CAD_COM"."COM_FMAI"'
      Size = 60
    end
    object cad_comCOM_FDDD: TIBStringField
      FieldName = 'COM_FDDD'
      Origin = '"CAD_COM"."COM_FDDD"'
      Size = 2
    end
    object cad_comCOM_FTE1: TIBStringField
      FieldName = 'COM_FTE1'
      Origin = '"CAD_COM"."COM_FTE1"'
      Size = 9
    end
    object cad_comCOM_FDD2: TIBStringField
      FieldName = 'COM_FDD2'
      Origin = '"CAD_COM"."COM_FDD2"'
      Size = 2
    end
    object cad_comCOM_FTE2: TIBStringField
      FieldName = 'COM_FTE2'
      Origin = '"CAD_COM"."COM_FTE2"'
      Size = 9
    end
    object cad_comCOM_FDD3: TIBStringField
      FieldName = 'COM_FDD3'
      Origin = '"CAD_COM"."COM_FDD3"'
      Size = 2
    end
    object cad_comCOM_FTE3: TIBStringField
      FieldName = 'COM_FTE3'
      Origin = '"CAD_COM"."COM_FTE3"'
      Size = 9
    end
    object cad_comCOM_FDD4: TIBStringField
      FieldName = 'COM_FDD4'
      Origin = '"CAD_COM"."COM_FDD4"'
      Size = 2
    end
    object cad_comCOM_FFAX: TIBStringField
      FieldName = 'COM_FFAX'
      Origin = '"CAD_COM"."COM_FFAX"'
      Size = 9
    end
    object cad_comCOM_FDD5: TIBStringField
      FieldName = 'COM_FDD5'
      Origin = '"CAD_COM"."COM_FDD5"'
      Size = 2
    end
    object cad_comCOM_FCEL: TIBStringField
      FieldName = 'COM_FCEL'
      Origin = '"CAD_COM"."COM_FCEL"'
      Size = 9
    end
    object cad_comCOM_FTC1: TIBStringField
      FieldName = 'COM_FTC1'
      Origin = '"CAD_COM"."COM_FTC1"'
      Size = 10
    end
    object cad_comCOM_FDD6: TIBStringField
      FieldName = 'COM_FDD6'
      Origin = '"CAD_COM"."COM_FDD6"'
      Size = 2
    end
    object cad_comCOM_FNCE: TIBStringField
      FieldName = 'COM_FNCE'
      Origin = '"CAD_COM"."COM_FNCE"'
      Size = 9
    end
    object cad_comCOM_FTC2: TIBStringField
      FieldName = 'COM_FTC2'
      Origin = '"CAD_COM"."COM_FTC2"'
      Size = 10
    end
    object cad_comCOM_FNID: TIBStringField
      FieldName = 'COM_FNID'
      Origin = '"CAD_COM"."COM_FNID"'
      Size = 15
    end
    object cad_comCOM_CCON: TIBStringField
      FieldName = 'COM_CCON'
      Origin = '"CAD_COM"."COM_CCON"'
      Size = 30
    end
    object cad_comCOM_CMAI: TIBStringField
      FieldName = 'COM_CMAI'
      Origin = '"CAD_COM"."COM_CMAI"'
      Size = 60
    end
    object cad_comCOM_CDDD: TIBStringField
      FieldName = 'COM_CDDD'
      Origin = '"CAD_COM"."COM_CDDD"'
      Size = 2
    end
    object cad_comCOM_CTE1: TIBStringField
      FieldName = 'COM_CTE1'
      Origin = '"CAD_COM"."COM_CTE1"'
      Size = 9
    end
    object cad_comCOM_CDD2: TIBStringField
      FieldName = 'COM_CDD2'
      Origin = '"CAD_COM"."COM_CDD2"'
      Size = 2
    end
    object cad_comCOM_CTE2: TIBStringField
      FieldName = 'COM_CTE2'
      Origin = '"CAD_COM"."COM_CTE2"'
      Size = 9
    end
    object cad_comCOM_CDD3: TIBStringField
      FieldName = 'COM_CDD3'
      Origin = '"CAD_COM"."COM_CDD3"'
      Size = 2
    end
    object cad_comCOM_CTE3: TIBStringField
      FieldName = 'COM_CTE3'
      Origin = '"CAD_COM"."COM_CTE3"'
      Size = 9
    end
    object cad_comCOM_CDD4: TIBStringField
      FieldName = 'COM_CDD4'
      Origin = '"CAD_COM"."COM_CDD4"'
      Size = 2
    end
    object cad_comCOM_CFAX: TIBStringField
      FieldName = 'COM_CFAX'
      Origin = '"CAD_COM"."COM_CFAX"'
      Size = 9
    end
    object cad_comCOM_CDD5: TIBStringField
      FieldName = 'COM_CDD5'
      Origin = '"CAD_COM"."COM_CDD5"'
      Size = 2
    end
    object cad_comCOM_CCEL: TIBStringField
      FieldName = 'COM_CCEL'
      Origin = '"CAD_COM"."COM_CCEL"'
      Size = 9
    end
    object cad_comCOM_CTC1: TIBStringField
      FieldName = 'COM_CTC1'
      Origin = '"CAD_COM"."COM_CTC1"'
      Size = 10
    end
    object cad_comCOM_CDD6: TIBStringField
      FieldName = 'COM_CDD6'
      Origin = '"CAD_COM"."COM_CDD6"'
      Size = 2
    end
    object cad_comCOM_CNCE: TIBStringField
      FieldName = 'COM_CNCE'
      Origin = '"CAD_COM"."COM_CNCE"'
      Size = 9
    end
    object cad_comCOM_CTC2: TIBStringField
      FieldName = 'COM_CTC2'
      Origin = '"CAD_COM"."COM_CTC2"'
      Size = 10
    end
    object cad_comCOM_CNID: TIBStringField
      FieldName = 'COM_CNID'
      Origin = '"CAD_COM"."COM_CNID"'
      Size = 15
    end
    object cad_comCOM_VDSC: TIBBCDField
      FieldName = 'COM_VDSC'
      Origin = '"CAD_COM"."COM_VDSC"'
      Precision = 9
      Size = 2
    end
    object cad_comCOM_CRED: TIBBCDField
      FieldName = 'COM_CRED'
      Origin = '"CAD_COM"."COM_CRED"'
      Precision = 9
      Size = 2
    end
    object cad_comCOM_SITE: TIBStringField
      FieldName = 'COM_SITE'
      Origin = '"CAD_COM"."COM_SITE"'
      Size = 120
    end
    object cad_comCOM_REVE: TIBStringField
      FieldName = 'COM_REVE'
      Origin = '"CAD_COM"."COM_REVE"'
      Size = 3
    end
    object cad_comCOM_IMUN: TIBStringField
      FieldName = 'COM_IMUN'
      Origin = '"CAD_COM"."COM_IMUN"'
    end
    object cad_comCOM_CCM: TIBStringField
      FieldName = 'COM_CCM'
      Origin = '"CAD_COM"."COM_CCM"'
    end
  end
end
