...
begin
  ...
  begin
    Close;
    SQL.Clear;
    SQL.Add('UPDATE ' + IFThen(cbTIPO.Text = 'ETIQUETA NORMAL','CAD_PRO_EST','CAD_PRO_DEF'));
...
begin
  ...
  begin
    SQL.Clear;
    SQL.Add('SELECT ID,EST_DOCU FROM CAD_PRO_EST');
    SQL.Add('WHERE  EST_CDET = '''+edcdet.Text+'''');
    ...
    aux.SQL.Clear;
    aux.SQL.Add('SELECT SUM(EST_CRED),COUNT(*) FROM CAD_PRO_SEP');
...
begin
  ...
  try
    ...
    begin
      SQL.Clear;
      SQL.Add('SELECT EST_CPRO,PRO_CPRO,PRO_DPRO,PRO_DUNI,PRO_DCOR,PRO_COMP,PRO_CCST,EST_CDET,EST_CRED FROM CAD_PRO,CAD_PRO_EST');
...
begin
  ...
  begin
    ...
    if cbTIPO.Text = 'ETIQUETA NORMAL' then
    SQL.Add('FROM     CAD_PRO,CAD_PRO_EST') else
