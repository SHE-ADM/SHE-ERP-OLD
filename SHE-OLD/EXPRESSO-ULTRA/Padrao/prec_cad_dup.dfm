inherited frmrec_cad_dup: Tfrmrec_cad_dup
  Left = 459
  Top = 20
  ...
  object fin_rec: TIBQuery
    ...
    object fin_recFIN_DMED: TDateField
      FieldName = 'FIN_DMED'
      Origin = '"FIN_REC_BAN_BAI"."FIN_DMED"'
    end
    object fin_recFIN_DATR: TDateField
      FieldName = 'FIN_DATR'
      Origin = '"FIN_REC_BAN_BAI"."FIN_DATR"'
    end
    ...
    object fin_recFIN_BANC: TIBStringField
      FieldName = 'FIN_BANC'
      Origin = '"FIN_REC_BAN_BAI"."FIN_BANC"'
      Size = 4
    end
    object fin_recFIN_DBAN: TIBStringField
      FieldName = 'FIN_DBAN'
      Origin = '"FIN_REC_BAN_BAI"."FIN_DBAN"'
      Size = 50
    end
    object fin_recFIN_AGEN: TIBStringField
      FieldName = 'FIN_AGEN'
      Origin = '"FIN_REC_BAN_BAI"."FIN_AGEN"'
      Size = 10
    end
    object fin_recFIN_CONT: TIBStringField
      FieldName = 'FIN_CONT'
      Origin = '"FIN_REC_BAN_BAI"."FIN_CONT"'
      Size = 15
    end
    object fin_recFIN_NCHQ: TIBStringField
      FieldName = 'FIN_NCHQ'
      Origin = '"FIN_REC_BAN_BAI"."FIN_NCHQ"'
      Size = 10
    end
    object fin_recFIN_MCHQ: TSmallintField
      FieldName = 'FIN_MCHQ'
      Origin = '"FIN_REC_BAN_BAI"."FIN_MCHQ"'
    end
    ...
    object fin_recFIN_STCO: TIBStringField
      FieldName = 'FIN_STCO'
      Origin = '"FIN_REC_BAN_BAI"."FIN_STCO"'
    end
    ...
    object fin_recFIN_OBSE: TMemoField
      FieldName = 'FIN_OBSE'
      Origin = '"FIN_REC_BAN_BAI"."FIN_OBSE"'
      ProviderFlags = [pfInUpdate]
      BlobType = ftMemo
      Size = 8
    end
    ...
    object fin_recFIN_VENC: TIBBCDField
      FieldName = 'FIN_VENC'
      Origin = '"FIN_REC_BAN_BAI"."FIN_VENC"'
      Precision = 18
      Size = 2
    end
    object fin_recFIN_CTNR: TIBStringField
      FieldName = 'FIN_CTNR'
      Origin = '"FIN_REC_BAN_BAI"."FIN_CTNR"'
    end
    object fin_recFIN_BCON: TIntegerField
      FieldName = 'FIN_BCON'
      Origin = '"FIN_REC_BAN_BAI"."FIN_BCON"'
    end
    object fin_recFIN_DCON: TIBStringField
      FieldName = 'FIN_DCON'
      Origin = '"FIN_REC_BAN_BAI"."FIN_DCON"'
      Size = 120
    end
    object fin_recFIN_LOTE: TIntegerField
      FieldName = 'FIN_LOTE'
      Origin = '"FIN_REC_BAN_BAI"."FIN_LOTE"'
    end
    object fin_recFIN_DLOT: TDateField
      FieldName = 'FIN_DLOT'
      Origin = '"FIN_REC_BAN_BAI"."FIN_DLOT"'
    end
    object fin_recFIN_CDCH: TSmallintField
      FieldName = 'FIN_CDCH'
      Origin = '"FIN_REC_BAN_BAI"."FIN_CDCH"'
    end
    object fin_recFIN_CPF: TIBStringField
      FieldName = 'FIN_CPF'
      Origin = '"FIN_REC_BAN_BAI"."FIN_CPF"'
      Size = 14
    end
    object fin_recFIN_VTER: TIBBCDField
      FieldName = 'FIN_VTER'
      Origin = '"FIN_REC_BAN_BAI"."FIN_VTER"'
      Precision = 18
      Size = 2
    end
    object fin_recFIN_VPRO: TIBBCDField
      FieldName = 'FIN_VPRO'
