  ...
  object imp_ite: TIBDataSet
    ...
    InsertSQL.Strings = (
      'insert into IMP_ITE'
        ...
        '  (CDET, CDEV, CDRO, CDSP, CF_VPRC_PAD, CF_VPRC_PAD_ORI, DTFK, D' +
        'TPK, DTSP, '
      
        '   EST_QTDE, EST_QTRL, FLAG, HOST, ID, IDAK, IDCP, IDEK, IDEP, I' +
        'DEV, IDFK, '
      
        '   IDPK, IDSK, IDSP, IP, ITEM, NFCI, PDSC, QTDE, QTRL, QTSP, RLS' +
        'P, ROM_ABCD, '
      
        '   ROM_APRC, ROM_CART, ROM_CBAR, ROM_CCAB, ROM_CCO2, ROM_CCOR, R' +
        'OM_CDET, '
        ...
        '   ROM_VPRC, ROM_VPRO, SEQUENCIA, TCDE, TSDE, UPRC_PAD, VDSC, VP' +
        'RC_COM, '
      '   VPRC_PAD, VPRC_PAD_FIM, VPRC_PAD_INI)'
      'values'
      
        '  (:CDET, :CDEV, :CDRO, :CDSP, :CF_VPRC_PAD, :CF_VPRC_PAD_ORI, :' +
        'DTFK, :DTPK, '
      
        '   :DTSP, :EST_QTDE, :EST_QTRL, :FLAG, :HOST, :ID, :IDAK, :IDCP,' +
        ' :IDEK, '
      
        '   :IDEP, :IDEV, :IDFK, :IDPK, :IDSK, :IDSP, :IP, :ITEM, :NFCI, ' +
        ':PDSC, '
      
        '   :QTDE, :QTRL, :QTSP, :RLSP, :ROM_ABCD, :ROM_APRC, :ROM_CART, ' +
        ':ROM_CBAR, '
      
        '   :ROM_CCAB, :ROM_CCO2, :ROM_CCOR, :ROM_CDET, :ROM_CDNF, :ROM_C' +
        'DOC, :ROM_CDPD, '
      
        '   :ROM_CDPR, :ROM_CDRO, :ROM_CGRD, :ROM_CPR2, :ROM_CPRO, :ROM_C' +
        'SEP, :ROM_CUST, '
      
        '   :ROM_DCO2, :ROM_DCOR, :ROM_DGRD, :ROM_DPRO, :ROM_DSEP, :ROM_D' +
        'UNI, :ROM_FLAG, '
      
        '   :ROM_FOTO, :ROM_IPR2, :ROM_IPRO, :ROM_ITEM, :ROM_LDSC, :ROM_M' +
        'ETR, :ROM_OBSE, '
      
        '   :ROM_PCO2, :ROM_PCOM, :ROM_PCOR, :ROM_PEMB, :ROM_PESO, :ROM_P' +
        'IPI, :ROM_PPRO, '
      
        '   :ROM_PRCA, :ROM_PREC, :ROM_PRPA, :ROM_PSCN, :ROM_PSMR, :ROM_Q' +
        'DIS, :ROM_QTDE, '
      
        '   :ROM_QTPD, :ROM_QTRL, :ROM_QTSP, :ROM_RCO2, :ROM_RCOR, :ROM_R' +
        'END, :ROM_RLDI, '
      
        '   :ROM_RLPD, :ROM_RLSP, :ROM_RPRC, :ROM_RPRO, :ROM_STFI, :ROM_T' +
        'OTA, :ROM_TPRC, '
      
        '   :ROM_UNIT, :ROM_VBCIPI, :ROM_VDSC, :ROM_VIPI, :ROM_VPRC, :ROM' +
        '_VPRO, '
      
        '   :SEQUENCIA, :TCDE, :TSDE, :UPRC_PAD, :VDSC, :VPRC_COM, :VPRC_' +
        'PAD, :VPRC_PAD_FIM, '
      '   :VPRC_PAD_INI)')
    RefreshSQL.Strings = (
      'Select '
    ...
    object imp_iteIDAK: TLargeintField
      FieldName = 'IDAK'
      Origin = '"IMP_ITE"."IDAK"'
    end
    object imp_iteIDEK: TLargeintField
      FieldName = 'IDEK'
      Origin = '"IMP_ITE"."IDEK"'
    end
    object imp_iteIDEP: TSmallintField
      FieldName = 'IDEP'
      Origin = '"IMP_ITE"."IDEP"'
    end
    object imp_iteIDPK: TLargeintField
      FieldName = 'IDPK'
      Origin = '"IMP_ITE"."IDPK"'
    end
    object imp_iteDTPK: TDateTimeField
      FieldName = 'DTPK'
      Origin = '"IMP_ITE"."DTPK"'
    end
    object imp_iteIDFK: TLargeintField
      FieldName = 'IDFK'
      Origin = '"IMP_ITE"."IDFK"'
    end
    object imp_iteDTFK: TDateTimeField
      FieldName = 'DTFK'
      Origin = '"IMP_ITE"."DTFK"'
    end
    object imp_iteCDRO: TLargeintField
      FieldName = 'CDRO'
      Origin = '"IMP_ITE"."CDRO"'
    end
    object imp_iteCDET: TLargeintField
      FieldName = 'CDET'
      Origin = '"IMP_ITE"."CDET"'
    end
    object imp_iteIDCP: TIntegerField
      FieldName = 'IDCP'
      Origin = '"IMP_ITE"."IDCP"'
    end
    object imp_iteIDSK: TLargeintField
      FieldName = 'IDSK'
      Origin = '"IMP_ITE"."IDSK"'
    end
    object imp_iteCF_VPRC_PAD_ORI: TIBStringField
      FieldName = 'CF_VPRC_PAD_ORI'
      Origin = '"IMP_ITE"."CF_VPRC_PAD_ORI"'
      FixedChar = True
      Size = 2
    end
    object imp_iteCF_VPRC_PAD: TFloatField
      FieldName = 'CF_VPRC_PAD'
      Origin = '"IMP_ITE"."CF_VPRC_PAD"'
    end
    object imp_iteVPRC_PAD_INI: TFloatField
      FieldName = 'VPRC_PAD_INI'
      Origin = '"IMP_ITE"."VPRC_PAD_INI"'
    end
    object imp_iteVPRC_PAD_FIM: TFloatField
      FieldName = 'VPRC_PAD_FIM'
      Origin = '"IMP_ITE"."VPRC_PAD_FIM"'
    end
    object imp_iteVPRC_PAD: TFloatField
      FieldName = 'VPRC_PAD'
      Origin = '"IMP_ITE"."VPRC_PAD"'
    end
    object imp_iteVPRC_COM: TFloatField
      FieldName = 'VPRC_COM'
      Origin = '"IMP_ITE"."VPRC_COM"'
    end
    object imp_itePDSC: TIBBCDField
      FieldName = 'PDSC'
      Origin = '"IMP_ITE"."PDSC"'
      Precision = 9
      Size = 2
    end
    object imp_iteVDSC: TIBBCDField
      FieldName = 'VDSC'
      Origin = '"IMP_ITE"."VDSC"'
      Precision = 18
      Size = 2
    end
    object imp_iteTSDE: TIBBCDField
      FieldName = 'TSDE'
      Origin = '"IMP_ITE"."TSDE"'
      Precision = 18
      Size = 2
    end
    object imp_iteTCDE: TIBBCDField
      FieldName = 'TCDE'
      Origin = '"IMP_ITE"."TCDE"'
      Precision = 18
      Size = 2
    end
    object imp_iteEST_QTDE: TIBBCDField
      FieldName = 'EST_QTDE'
      Origin = '"IMP_ITE"."EST_QTDE"'
      Precision = 18
      Size = 4
    end
    object imp_iteEST_QTRL: TIntegerField
      FieldName = 'EST_QTRL'
      Origin = '"IMP_ITE"."EST_QTRL"'
    end
    object imp_iteQTDE: TIBBCDField
      FieldName = 'QTDE'
      Origin = '"IMP_ITE"."QTDE"'
      Precision = 18
      Size = 4
    end
    object imp_iteQTRL: TIntegerField
      FieldName = 'QTRL'
      Origin = '"IMP_ITE"."QTRL"'
    end
    object imp_iteIDSP: TSmallintField
      FieldName = 'IDSP'
      Origin = '"IMP_ITE"."IDSP"'
    end
    object imp_iteCDSP: TLargeintField
      FieldName = 'CDSP'
      Origin = '"IMP_ITE"."CDSP"'
    end
    object imp_iteDTSP: TDateTimeField
      FieldName = 'DTSP'
      Origin = '"IMP_ITE"."DTSP"'
    end
    object imp_iteQTSP: TIBBCDField
      FieldName = 'QTSP'
      Origin = '"IMP_ITE"."QTSP"'
      Precision = 18
      Size = 4
    end
    object imp_iteRLSP: TIntegerField
      FieldName = 'RLSP'
      Origin = '"IMP_ITE"."RLSP"'
    end
    object imp_iteNFCI: TIBStringField
      FieldName = 'NFCI'
      Origin = '"IMP_ITE"."NFCI"'
      Size = 40
    end
    object imp_iteFLAG: TSmallintField
      FieldName = 'FLAG'
      Origin = '"IMP_ITE"."FLAG"'
    end
    object imp_iteUPRC_PAD: TIBBCDField
      FieldName = 'UPRC_PAD'
      Origin = '"IMP_ITE"."UPRC_PAD"'
      Precision = 9
      Size = 2
    end
    object imp_iteIP: TIBStringField
      FieldName = 'IP'
      Origin = '"IMP_ITE"."IP"'
    end
    object imp_iteHOST: TIBStringField
      FieldName = 'HOST'
      Origin = '"IMP_ITE"."HOST"'
      Size = 30
    end
    object imp_iteSEQUENCIA: TIntegerField
      FieldName = 'SEQUENCIA'
      Origin = '"IMP_ITE"."SEQUENCIA"'
    end
    object imp_iteITEM: TIntegerField
      FieldName = 'ITEM'
      Origin = '"IMP_ITE"."ITEM"'
    end
    object imp_iteIDEV: TLargeintField
      FieldName = 'IDEV'
      Origin = '"IMP_ITE"."IDEV"'
    end
    object imp_iteCDEV: TSmallintField
      FieldName = 'CDEV'
      Origin = '"IMP_ITE"."CDEV"'
    end
  end
