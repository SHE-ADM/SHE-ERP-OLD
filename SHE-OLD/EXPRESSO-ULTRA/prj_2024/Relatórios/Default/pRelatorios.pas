...
Type
  TFrmRelatorios = class(TForm)
    ...
    procedure ACTGerencial_Tipo_CreditoExecute(Sender: TObject);
    ...
    procedure ACTFinanceiro_AbatimentoExecute(Sender: TObject);
    ...
    procedure ACTGFinanceiro_Cadastros_DuplicataExecute(Sender: TObject);
...
uses uPrincipal, bPrincipal,
  qGerencial_Tipo_Credito, qGerencial_Tipo_Venda, qGerencial_Estoque_Unidade_Medida,
  qGerencial_NF_Peso,
  ...
  qPROSpedFiscal, qFicha_Tecnica, qGFornecedoresProdutosCadastrados,
...
procedure TFrmRelatorios.ACTFinanceiro_AbatimentoExecute(Sender: TObject);
begin
//  qrpFinanceiro_Abatimento := TqrpFinanceiro_Abatimento.Create(Self,RECRelatorios);
//  qrpFinanceiro_Abatimento.WinControlFormCreate(qrpFinanceiro_Abatimento);
end;

procedure TFrmRelatorios.ACTGFinanceiro_Cadastros_DuplicataExecute(
  Sender: TObject);
begin
{  qrpGFinanceiro_Cadastros_Duplicata := TqrpGFinanceiro_Cadastros_Duplicata.Create(Self,RECRelatorios);
  qrpGFinanceiro_Cadastros_Duplicata.WinControlFormCreate(qrpGFinanceiro_Cadastros_Duplicata);}
end;
...
procedure TFrmRelatorios.ACTGFornecedoresProdutosCadastradosExecute(
  Sender: TObject);
begin
...
procedure TFrmRelatorios.ACTGerencial_Tipo_CreditoExecute(Sender: TObject);
begin
  if not Assigned(qrpGerencial_Tipo_Credito) then
  begin
    qrpGerencial_Tipo_Credito := TqrpGerencial_Tipo_Credito.Create(Self,RECRelatorios);
    qrpGerencial_Tipo_Credito.WinControlFormCreate(qrpGerencial_Tipo_Credito);
  end;
end;
  ...
  case RECRelatorios.Perfil of
    0: begin
         ...
         begin
           ...
           if not bPSQUSER('USU_PRIN','Produtos','Estoque','Re-Emissão de Etiquetas') then
           begin
   ...
   14: begin
         ...
         begin
           ...
           IENome.Values.Add('ACTGerencial_Tipo_Credito');
           IENome.Text := 'ACTGerencial_Tipo_Credito';
