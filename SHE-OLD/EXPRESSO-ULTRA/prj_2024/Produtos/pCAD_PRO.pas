...
uses
  ...
  dxDBTLCl, dxGrClms,
  math, StrUtils,
  DBCtrls, dxEditor, dxEdLib, dxDBELib,
  IDGlobal;
...
type
  TFrmCAD_PRO = class(TFrmSHE_DEF_PSQ)
    ...
    PNLFIS_INFADCAD: TPanel;
    DSFIS_INFADCAD: TdxDockSite;
    dxLayoutDockSite3: TdxLayoutDockSite;
    DPFIS_INFADCAD: TdxDockPanel;
    DBFIS_INFADCAD: TdxDBMemo;
    PNLERV_INFADCAD: TPanel;
    DSERV_INFADCAD: TdxDockSite;
    dxLayoutDockSite5: TdxLayoutDockSite;
    DPERV_INFADCAD: TdxDockPanel;
    DBERV_INFADCAD: TdxDBMemo;
    PNLEPE_INFADCAD: TPanel;
    DSEPE_INFADCAD: TdxDockSite;
    dxLayoutDockSite6: TdxLayoutDockSite;
    DPEPE_INFADCAD: TdxDockPanel;
    DBEPE_INFADCAD: TdxDBMemo;
    ...
    PNLEPI_INFADCAD: TPanel;
    DSEPI_INFADCAD: TdxDockSite;
    dxLayoutDockSite7: TdxLayoutDockSite;
    DPEPI_INFADCAD: TdxDockPanel;
    DBEPI_INFADCAD: TdxDBMemo;
    ...
    PNLESU_INFADCAD: TPanel;
    DSESU_INFADCAD: TdxDockSite;
    dxLayoutDockSite8: TdxLayoutDockSite;
    DPESU_INFADCAD: TdxDockPanel;
    DBESU_INFADCAD: TdxDBMemo;
    PNLEAT_INFADCAD: TPanel;
    DSEAT_INFADCAD: TdxDockSite;
    dxLayoutDockSite9: TdxLayoutDockSite;
    DPEAT_INFADCAD: TdxDockPanel;
    DBEAT_INFADCAD: TdxDBMemo;
    EST_ESU: TIBQuery;
    ...
    PNLCPA_INFADCAD: TPanel;
    DSCPA_INFADCAD: TdxDockSite;
    dxLayoutDockSite10: TdxLayoutDockSite;
    DPCPA_INFADCAD: TdxDockPanel;
    DBCPA_INFADCAD: TdxDBMemo;
    PNLCPF_INFADCAD: TPanel;
    DSCPF_INFADCAD: TdxDockSite;
    dxLayoutDockSite11: TdxLayoutDockSite;
    DPCPF_INFADCAD: TdxDockPanel;
    DBCPF_INFADCAD: TdxDBMemo;
    PNLPRG_INFADCAD: TPanel;
    DSPRG_INFADCAD: TdxDockSite;
    dxLayoutDockSite12: TdxLayoutDockSite;
    DPPRG_INFADCAD: TdxDockPanel;
    DBPRG_INFADCAD: TdxDBMemo;
    PNLRES_INFADCAD: TPanel;
    DSRES_INFADCAD: TdxDockSite;
    dxLayoutDockSite13: TdxLayoutDockSite;
    DPRES_INFADCAD: TdxDockPanel;
    DBRES_INFADCAD: TdxDBMemo;
    PNLSEP_INFADCAD: TPanel;
    DSSEP_INFADCAD: TdxDockSite;
    dxLayoutDockSite14: TdxLayoutDockSite;
    DPSEP_INFADCAD: TdxDockPanel;
    DBSEP_INFADCAD: TdxDBMemo;
    ...
    PNLCAD_PRO_IMG_INF: TPanel;
    DPCAD_PRO_IMG_ILA: TdxDockPanel;
    PNLCAD_PRO_IMG_ILA: TPanel;
...
procedure TFrmCAD_PRO.ACTPesquisaExecute(Sender: TObject);
          ...
          begin
            ...
            if REC_SHE_DEF.PSQ_FB_VLD <> EmptyStr then
               try
                 APSQ_DG := EmptyStr; { Grade }
                 APSQ_FD := EmptyStr; { Campo }
                 APSQ_VL := REC_SHE_DEF.PSQ_FB_VLD; { Texto Pesquisa }
                 ...
                 begin
                   ...
                   SQL.Add('       CP.IDAK,CP.ARTIGO,CP.DECP,');
                   SQL.Add('       CP.NCM ,CP.PIPI,');
                   SQL.Add('       CP.IDCF,CP.DECF,');
                   SQL.Add('       CP.UCOM,CP.UCON,');

                   SQL.Add('       MAX(CP.LJV_UCOM)      AS LJV_UCOM     ,MAX(CP.LJV_UCON)      AS LJV_UCON     ,');
                   ...
                   { Padrão }
                   if ((APSQ_SL.Count = 0) and ((BDPSQ_PER_INI.Date <= 0) or (BDPSQ_PER_FIM.Date <= 0))) then
                   begin
...
begin
  if key = vk_return then
     with REC_SHE_DEF do
     begin
       PSQ_FB_VLD := TRIM(BEPSQ_CAD.Text);

       PSQ_WHERE := ' LIKE ';
       PSQ_LKINI := '''' ;
       PSQ_LKFIM := '%''';

       if ((Length(PSQ_FB_VLD) <= 2) or (Pos('.',PSQ_FB_VLD) > 0)) then
       PSQ_FB_FLD := 'ARTIGO';

       if oBSONumero(PSQ_FB_VLD) then
       begin
         PSQ_WHERE := ' = ';
         PSQ_LKINI := '''' ;
         PSQ_LKFIM := '''' ;
...
procedure TFrmCAD_PRO.ConsultaBeforeOpen(DataSet: TDataSet);
begin
  inherited;
...
begin
  ...
  IFThen((APosCount = 00) and (ConsultaINFADTEC.AsString =  EmptyStr) ,87,
  IFThen((APosCount = 00) and (ConsultaINFADTEC.AsString <> EmptyStr) ,87,
  IFThen((APosCount = 01),087,
...
procedure TFrmCAD_PRO.DTSCAD_PRO_IMGDataChange(Sender: TObject;
  Field: TField);
begin
  PNLCAD_PRO_IMG_INF.Caption := _oLoadJPG(CAD_PRO_IMGIMG_ID,CAD_PRO_IMGIMG_PAD,IMGCAD_PRO_IMG_PAD);
...
procedure TFrmCAD_PRO.IMGCAD_PRO_IMG_PADClick(Sender: TObject);
begin
  {$IF DEFINED(DEF_CPA)}
  {$ELSE}
...
begin
  ...
  { Relatórios }
  PNLRES_INFADPRN.Height  := 0;
  PNLRES_INFADPRN.Caption := EST_RESINFADPRN.AsString;

  if EST_RESINFADPRN.AsString <> EmptyStr then
  begin
    PNLRES_INFADPRN.Height := 20;
    PNLRES_INFADCAD.Height := IFThen(PNLRES_INFADCAD.Height = 0,60,PNLRES_INFADCAD.Height + PNLRES_INFADPRN.Height);
  end;
