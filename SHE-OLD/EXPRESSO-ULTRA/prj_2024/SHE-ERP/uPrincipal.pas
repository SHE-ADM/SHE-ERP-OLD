...
type
  TFrmPrincipal = class(TForm)
    ...
    SSIETQ_PRO: TdxStoredSideItem;
    BLBCAD_CLI: TdxBarLargeButton;
    BLBCAD_REP: TdxBarLargeButton;
    BLBCAD_VEN: TdxBarLargeButton;
    BLBCAD_COM: TdxBarLargeButton;
    BLBCAD_TRA: TdxBarLargeButton;
    BLBCAD_FOR: TdxBarLargeButton;
    BLGCAD_PRO: TdxBarLargeButton;
    BLGTAB_GRD_COR: TdxBarLargeButton;
    BLBTAB_GRD_EST: TdxBarLargeButton;
    BLBPRO_FCT: TdxBarLargeButton;
    BLBETQ_PRO: TdxBarLargeButton;
    BLBTAB_COL: TdxBarLargeButton;
    BLBTAB_SEG: TdxBarLargeButton;
    BLBTAB_GRP: TdxBarLargeButton;
    BLBTAB_SGP: TdxBarLargeButton;
    BLBTAB_CAT: TdxBarLargeButton;
    BLBTAB_SCT: TdxBarLargeButton;
    BLBEST_LAN: TdxBarLargeButton;
    BLBEST_ADM: TdxBarLargeButton;
    BLBETQ_EST: TdxBarLargeButton;
    BLBQLD_CAD: TdxBarLargeButton;
    BLBEXP_COL: TdxBarLargeButton;
    BLBEXP_MAN: TdxBarLargeButton;
    BLBCTNR_CAD: TdxBarLargeButton;
    BLBTCTNR_CUSTOS: TdxBarLargeButton;
    BSIEstoque: TdxBarSubItem;
    BDIExpedicao: TdxBarSubItem;
    BSIContainers: TdxBarSubItem;
    BLBPED_COM_LAN: TdxBarLargeButton;
    BLBPED_COM_ADM: TdxBarLargeButton;
    BLBPED_PRG_LAN: TdxBarLargeButton;
    BLBPED_PRG_ADM: TdxBarLargeButton;
    BLBPED_VEN_LAN: TdxBarLargeButton;
    BLBPED_VEN_ADM: TdxBarLargeButton;
    BLBTAB_PRZ: TdxBarLargeButton;
    BLBROM_LAN: TdxBarLargeButton;
    BLBROM_ADM: TdxBarLargeButton;
    BLBNFE_LAN: TdxBarLargeButton;
    BLBNFE_ADM: TdxBarLargeButton;
    BLBNFE_LAN_TER: TdxBarLargeButton;
    BLBTAB_NAT_2: TdxBarLargeButton;
    BLBCFE_LAN: TdxBarLargeButton;
    BLBCFE_ADM: TdxBarLargeButton;
    BLBFIN_REC_BAN: TdxBarLargeButton;
    BLBFIN_REC_CAR: TdxBarLargeButton;
    BLBFIN_REC_DUP: TdxBarLargeButton;
    BLBFIN_REC_BOL: TdxBarLargeButton;
    BLBFIN_REC_IBB: TdxBarLargeButton;
    BLBFIN_PAG_ADM: TdxBarLargeButton;
    BLBFIN_PAG_CMV: TdxBarLargeButton;
    BLBCHQ_LAN: TdxBarLargeButton;
    BLBCHQ_ADM: TdxBarLargeButton;
    BLBCAI_ABR: TdxBarLargeButton;
    BLBCAI_RAB: TdxBarLargeButton;
    BLBCAI_FEC: TdxBarLargeButton;
    BLBCAI_SAN: TdxBarLargeButton;
    BLBTAB_SAN: TdxBarLargeButton;
    BLBCAI_FLC: TdxBarLargeButton;
    BLBTAB_PRZ_2: TdxBarLargeButton;
    ...
    BLBSM_LOG: TdxBarLargeButton;
    BLBSM_LOG_PASSWORD: TdxBarLargeButton;
    BLBSM_C3: TdxBarLargeButton;
    BLBSM_PRN: TdxBarLargeButton;
    BLBSM_Sistema: TdxBarLargeButton;
    BLBSM_Backup: TdxBarLargeButton;
    BLBSM_C4: TdxBarLargeButton;
    BLBSM_C5: TdxBarLargeButton;
    BLBSM_Saida: TdxBarLargeButton;
...
uses bPrincipal,
     ...
     AJBarcode, pImpressoras, pConstrucao;
