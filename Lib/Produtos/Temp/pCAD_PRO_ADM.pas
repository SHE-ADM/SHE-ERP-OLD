...
type
  TFrmCAD_PRO_ADM = class(TForm)
    ...
    DBGConsultaCP_IDEP: TdxDBGridMaskColumn;
    ...
    DBGEST_EFISGEP: TdxDBGridMaskColumn;
    DBGEST_EFIGRD_SG: TdxDBGridMaskColumn;
    DBGEST_EFIDGCP: TdxDBGridMaskColumn;
    ...
    EST_ESPIDEP: TSmallintField;
    EST_ESPSGEP: TIBStringField;
    EST_ESPABCR: TIBStringField;
    ...
    EST_EPVIDEP: TSmallintField;
    EST_EPVSGEP: TIBStringField;
    EST_EPVDSPK: TDateTimeField;
    EST_EPVABCR: TIBStringField;
    EST_EPVD_STCO: TIBStringField;
    EST_EPVQTDE: TIBBCDField;
    EST_EPPIDEP: TSmallintField;
    EST_EPPSGEP: TIBStringField;
    EST_EPPDSPK: TDateTimeField;
    EST_EPPABCR: TIBStringField;
    ...
    EST_CPFCF_VPRC_PAD_ORI: TIBStringField;
    EST_CPFCF_VPRC_COM: TFloatField;
...
begin
  ...
  FrmCAD_PRO_EDI := TFrmCAD_PRO_EDI.Create(Self,
                                           ConsultaCP_IDEP.AsInteger,
                                           ConsultaIDAK.AsInteger,
                                           0,
                                           3,
                                           EmptyStr,
                                           EmptyStr);
...
begin
  ...
  try
    ...
    begin
      ...
      SQL.Add('AND PK.GRD_NO LIKE ''' + REC_SHE_DEF.PSQ_FB_CP_DGCP + '%''');
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            SQL.Add('UNION ALL');
            SQL.Add('SELECT PK.* FROM PK AS PK');
            SQL.Add('WHERE  PK.GRD_NO LIKE ''' + REC_SHE_DEF.PSQ_FB_SL_PK.Strings[i] + '%''');
    ...
    VCDSPrincipal1RodapeLE.Tag     := DBGEST_EPESKU.Width       + DBGEST_EPESGEP.Width  + 5 + { Produtos }
...
procedure TFrmCAD_PRO_ADM.DBGCAD_PRO_FICCustomDrawCell(Sender: TObject;
  ACanvas: TCanvas; ARect: TRect; ANode: TdxTreeListNode;
  AColumn: TdxTreeListColumn; ASelected, AFocused, ANewItemRow: Boolean;
  var AText: String; var AColor: TColor; AFont: TFont;
  var AAlignment: TAlignment; var ADone: Boolean);
