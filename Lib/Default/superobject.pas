...
// Existe um bug para delphi 7 ou inferior, a correção realizada veio a partir deste post
// http://sammycomp.wordpress.com/2011/11/24/superobject-integer-overflow-error/
// é um bug conhecido pela desenvolvedora da biblioteca
{$OVERFLOWCHECKS OFF}
