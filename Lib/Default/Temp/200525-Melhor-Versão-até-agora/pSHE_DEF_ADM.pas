...
begin
  ...
  { Largura }
  _SetDockView(DPPrincipal1LE,lHorizontal,DPPrincipal1LE.Tag); { LE }
  _SetDockView(DPPrincipal1LD,lHorizontal,DPPrincipal1LD.Tag); { LD }

  { Altura }
  _SetDockView(DPPrincipal1Titulo  ,lVertical,DPPrincipal1Titulo.Tag  ); { Título }
  _SetDockView(DPPrincipal1INFADCAD,lVertical,DPPrincipal1INFADCAD.Tag); { Informações Adicionais }
  _SetDockView(DPPrincipal1INFADCPL,lVertical,DPPrincipal1INFADCPL.Tag); { Informações Complementares }

  { CONSULTA DOCK MANAGER }
  { Largura LE }
  _SetDockView(TCDSPrincipal1ConsultaLE,lHorizontal,TCDSPrincipal1ConsultaLE.Tag);
  _SetDockView(DPPrincipal1ConsultaLE1 ,lHorizontal,DPPrincipal1ConsultaLE1.Tag );
  _SetDockView(DPPrincipal1ConsultaLE2 ,lHorizontal,DPPrincipal1ConsultaLE2.Tag );

  { Largura LD }
  _SetDockView(TCDSPrincipal1ConsultaLD,lHorizontal,TCDSPrincipal1ConsultaLD.Tag);
  _SetDockView(DPPrincipal1ConsultaLD1 ,lHorizontal,DPPrincipal1ConsultaLD1.Tag );
  _SetDockView(DPPrincipal1ConsultaLD2 ,lHorizontal,DPPrincipal1ConsultaLD2.Tag );

  { RODAPÉ DOCK MANAGER }
  { Largura LE }
  _SetDockView(VCDSPrincipal1RodapeLE,lHorizontal,VCDSPrincipal1RodapeLE.Tag);
  _SetDockView(TCDSPrincipal1RodapeLE,lHorizontal,TCDSPrincipal1RodapeLE.Tag);
  _SetDockView(DPPrincipal1RodapeLE1 ,lHorizontal,DPPrincipal1RodapeLE1.Tag );
  _SetDockView(DPPrincipal1RodapeLE2 ,lHorizontal,DPPrincipal1RodapeLE2.Tag );

  { Largura LD }
  _SetDockView(VCDSPrincipal1RodapeLD,lHorizontal,VCDSPrincipal1RodapeLD.Tag);
  _SetDockView(TCDSPrincipal1RodapeLD,lHorizontal,TCDSPrincipal1RodapeLD.Tag);
  _SetDockView(DPPrincipal1RodapeLD1 ,lHorizontal,DPPrincipal1RodapeLD1.Tag );
  _SetDockView(DPPrincipal1RodapeLD2 ,lHorizontal,DPPrincipal1RodapeLD2.Tag );

  { Altura }
  _SetDockView(DPPrincipal1RodapeLEB,lVertical,DPPrincipal1RodapeLEB.Tag); { LEB }
  _SetDockView(DPPrincipal1RodapeLDB,lVertical,DPPrincipal1RodapeLDB.Tag); { LDB }

  _SetDockView(DPPrincipal1RodapeTitulo,lVertical,DPPrincipal1RodapeTitulo.Tag);
  _SetDockView(DPPrincipal1Rodape      ,lVertical,DPPrincipal1Rodape.Tag      );
