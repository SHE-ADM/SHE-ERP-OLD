object FBird: TFBird
  ...
  object DBB2B: TIBDatabase
    DatabaseName = '198.50.189.229/3050:C:\dbFirebird\LebiancoB2B.fdb'
    Params.Strings = (
      'user_name=SYSDBA'
      'password=ri1903'
      'lc_ctype=WIN1252')
  ...
  object QFBUsuarios: TIBQuery
    ...
    SQL.Strings = (
      'SELECT * '
      'FROM         CAD_USU_ADM'
      'WHERE      USU_CUSU = :USU_CUSU'
      'ORDER BY USU_FUNC,USU_ROTI,USU_NOME')
    Left = 208
    Top = 200
    ParamData = <
      item
  ...
  object CDSFBUsuarios: TClientDataSet
    ...
    Left = 208
    Top = 296
    object CDSFBUsuariosID: TIntegerField
      FieldName = 'ID'
      Required = True
    end
    object CDSFBUsuariosUSU_CUSU: TIntegerField
      FieldName = 'USU_CUSU'
    end
    object CDSFBUsuariosUSU_FUNC: TStringField
      FieldName = 'USU_FUNC'
      Size = 50
    end
    object CDSFBUsuariosUSU_ROTI: TStringField
      FieldName = 'USU_ROTI'
      Size = 50
    end
    object CDSFBUsuariosUSU_NOME: TStringField
      FieldName = 'USU_NOME'
      Size = 120
    end
    object CDSFBUsuariosUSU_NOVO: TStringField
      FieldName = 'USU_NOVO'
      FixedChar = True
      Size = 1
    end
    object CDSFBUsuariosUSU_EDIT: TStringField
      FieldName = 'USU_EDIT'
      FixedChar = True
      Size = 1
    end
    object CDSFBUsuariosUSU_DELE: TStringField
      FieldName = 'USU_DELE'
      FixedChar = True
      Size = 1
    end
    object CDSFBUsuariosUSU_VISU: TStringField
      FieldName = 'USU_VISU'
      FixedChar = True
      Size = 1
    end
    object CDSFBUsuariosUSU_PRIN: TStringField
      FieldName = 'USU_PRIN'
      FixedChar = True
      Size = 1
    end
    object CDSFBUsuariosUSU_AUTO: TStringField
      FieldName = 'USU_AUTO'
      FixedChar = True
      Size = 1
    end
    object CDSFBUsuariosUSU_CTRL: TStringField
      FieldName = 'USU_CTRL'
      FixedChar = True
      Size = 1
    end
    object CDSFBUsuariosUSU_PDSC: TStringField
      FieldName = 'USU_PDSC'
      FixedChar = True
      Size = 1
    end
    object CDSFBUsuariosUSU_PCRE: TStringField
      FieldName = 'USU_PCRE'
      FixedChar = True
      Size = 1
    end
    object CDSFBUsuariosUSU_MCRE: TStringField
      FieldName = 'USU_MCRE'
      FixedChar = True
      Size = 1
    end
    object CDSFBUsuariosUSU_FINA: TSmallintField
      FieldName = 'USU_FINA'
    end
    object CDSFBUsuariosFLAG: TSmallintField
      FieldName = 'FLAG'
    end
  end
  ...
  object QFBResumo_Mensal: TIBQuery
    ...
    SQL.Strings = (
      ...
      '       TRIM(CASE LEFT(PERIODO,3)'
      '              WHEN '#39'01/'#39' THEN '#39'JANEIRO  '#39
      '              WHEN '#39'02/'#39' THEN '#39'FEVEREIRO'#39
      '              WHEN '#39'03/'#39' THEN '#39'MAR'#199'O    '#39
      '              WHEN '#39'04/'#39' THEN '#39'ABRIL    '#39
      '              WHEN '#39'05/'#39' THEN '#39'MAIO     '#39
      '              WHEN '#39'06/'#39' THEN '#39'JUNHO    '#39
      '              WHEN '#39'07/'#39' THEN '#39'JULHO    '#39
      '              WHEN '#39'08/'#39' THEN '#39'AGOSTO   '#39
      '              WHEN '#39'09/'#39' THEN '#39'SETEMBRO '#39
      '              WHEN '#39'10/'#39' THEN '#39'OUTUBRO  '#39
      '              WHEN '#39'11/'#39' THEN '#39'NOVEMBRO '#39
      '              WHEN '#39'12/'#39' THEN '#39'DEZEMBRO '#39
      '            END ) AS PERIODO_EXT,'
      '       SUM(PVCLI) AS PVCLI,SUM(NVCLI) AS NVCLI,'
      
        '       SUM(QTVEN) AS QTVEN,SUM(VTVEN) AS VTVEN,SUM(VTDEV) AS VTD' +
        'EV,SUM(VTFAT-VTDEV) AS VTFAT'
      'FROM ('
      'SELECT   PS.FANTASIA AS EMPRESA,'
      
        '         LPad(Extract(Month FROM CAST(PK.DTCA AS DATE)),2,0)||'#39'/' +
        #39'||RIGHT(LPad(Extract(Year  FROM CAST(PK.DTCA AS DATE)),4,0),2) ' +
        'PERIODO,'
      
        '         COUNT(DISTINCT (IIF(LPad(Extract(Month FROM CL.CLI_DCAD' +
        '),2,0)||'#39'/'#39'||LPad(Extract(Year  FROM CL.CLI_DCAD),4,0) = LPad(Ex' +
        'tract(Month FROM CAST(PK.DTCA AS DATE)),2,0)||'#39'/'#39'||LPad(Extract(' +
        'Year  FROM CAST(PK.DTCA AS DATE)),4,0),CL.ID,NULL))) AS NVCLI,'
      '         COUNT(DISTINCT PK.ROM_CCLI) PVCLI,'
      '         COUNT(DISTINCT FK.IDPK    ) QTVEN,'
      
        '         COALESCE(SUM(IIF(PK.ROM_STPD <> '#39'DEVOLU'#199#195'O'#39',FK.TCDE,0))' +
        ',0) AS VTVEN,'
      ...
      'JOIN   ped_ven_ite AS FK ON (FK.IDPK = PK.ID)'
      'JOIN     CAD_CLI     AS CL ON (CL.ID = PK.ROM_CCLI)'
      'JOIN     CAD_PRO     AS CP ON (CP.ID = FK.IDCP    )'
      'JOIN     TAB_PAR_SIS AS PS ON (PS.ID = CP.PRO_CDEP)'
      'WHERE    PK.IDEP = '#39'1'#39
      'AND      PK.FAPD = 1'
      'AND      PK.STPD <> '#39'ABATIMENTO'#39
      
        'AND      CAST(PK.DTCA AS DATE) >= CAST('#39'01/01/'#39'||EXTRACT(YEAR FR' +
        'OM CURRENT_DATE) AS DATE)'
      'GROUP BY EMPRESA,PERIODO'
      'UNION'
      'SELECT   PS.FANTASIA AS EMPRESA,'
      
        '         LPad(Extract(Month FROM CAST(PK.DTNF AS DATE)),2,0)||'#39'/' +
        #39'||RIGHT(LPad(Extract(Year  FROM CAST(PK.DTNF AS DATE)),4,0),2) ' +
        'PERIODO,'
      '         0 AS NVCLI,0 PVCLI,0 QTVEN,0 AS VTVEN,0 AS VTDEV,'
      
        '         COALESCE(SUM(FK.ROM_PREC*FK.ROM_QTDE*IIF(PK.ROM_CONC > ' +
        '0,PK.ROM_CONC,1)),0) AS VTFAT'
      'FROM   rom_cab AS PK'
      'JOIN   rom_ite AS FK ON (FK.IDPK = PK.ID)'
      'JOIN     CAD_CLI     AS CL ON (CL.ID = PK.ROM_CCLI)'
      'JOIN     CAD_PRO     AS CP ON (CP.ID = FK.IDCP    )'
      'JOIN     TAB_PAR_SIS AS PS ON (PS.ID = CP.PRO_CDEP)'
      'WHERE    PK.IDEP = '#39'1'#39
      'AND      PK.FAPD = 1'
        ...
        'AND      CAST(PK.DTNF AS DATE) >= CAST('#39'01/01/'#39'||EXTRACT(YEAR FR' +
        'OM CURRENT_DATE) AS DATE)'
      'GROUP BY EMPRESA,PERIODO)'
      'GROUP BY EMPRESA,PERIODO '
    ...
    Left = 657
    Top = 152
    object QFBResumo_MensalEMPRESA: TIBStringField
      DisplayLabel = 'Nome'
      FieldName = 'EMPRESA'
      ProviderFlags = []
      Size = 60
    end
    object QFBResumo_MensalPERIODO: TIBStringField
      DisplayLabel = 'Per'#237'odo'
      FieldName = 'PERIODO'
      ProviderFlags = []
      Size = 7
    end
    object QFBResumo_MensalPERIODO_EXT: TIBStringField
      DisplayLabel = 'Per'#237'odo'
      FieldName = 'PERIODO_EXT'
      ProviderFlags = []
      Size = 9
    end
    object QFBResumo_MensalPVCLI: TLargeintField
      DisplayLabel = 'Pedidos'
      FieldName = 'PVCLI'
      ProviderFlags = []
      DisplayFormat = '0'
    end
    object QFBResumo_MensalNVCLI: TLargeintField
      DisplayLabel = 'Novos'
      FieldName = 'NVCLI'
      ProviderFlags = []
      DisplayFormat = '0'
    end
    object QFBResumo_MensalQTVEN: TLargeintField
      DisplayLabel = 'Qtde.'
      FieldName = 'QTVEN'
      ProviderFlags = []
      DisplayFormat = '0'
    end
    object QFBResumo_MensalVTVEN: TIBBCDField
    ...
    object QFBResumo_MensalVTDEV: TIBBCDField
      DisplayLabel = 'Dev. R$'
      FieldName = 'VTDEV'
      ProviderFlags = []
      DisplayFormat = ',##,0.00'
    ...
    object QFBResumo_MensalVTFAT: TFloatField
  ...
  object QFBResumo_Diario: TIBQuery
    ...
    SQL.Strings = (
      ...
      '         SUM(PVCLI) AS PVCLI,SUM(NVCLI) AS NVCLI,'
        ...
        '         SUM(QTVEN) AS QTVEN,SUM(VTVEN) AS VTVEN,SUM(VTDEV) AS V' +
        'TDEV,SUM(VTFAT-VTDEV) AS VTFAT'
      'FROM ('
      
        'SELECT   PS.FANTASIA AS EMPRESA,CAST(PK.DTCA AS DATE) AS PERIODO' +
        ','
      
        '         COUNT(DISTINCT (IIF(CL.CLI_DCAD = CAST(PK.DTCA AS DATE)' +
        ',CL.ID,NULL))) AS NVCLI,'
      '         COUNT(DISTINCT PK.ROM_CCLI) PVCLI,'
      '         COUNT(DISTINCT FK.IDPK    ) QTVEN,'
      ...
      'AND      PK.STPD <> '#39'ABATIMENTO'#39
        ...
        'AND     (CAST(PK.DTCA AS DATE) BETWEEN (DATEADD(1 - EXTRACT(DAY ' +
        'FROM CURRENT_DATE) DAY TO CURRENT_DATE )) AND (DATEADD(-EXTRACT(' +
        'DAY FROM DATEADD(1 MONTH TO CURRENT_DATE )) DAY TO DATEADD(1 MON' +
        'TH TO CURRENT_DATE))))'
      'GROUP BY EMPRESA,PERIODO'
      'UNION'
      
        'SELECT   PS.FANTASIA AS EMPRESA,CAST(PK.DTNF AS DATE) AS PERIODO' +
        ','
      '         0 AS NVCLI,0 PVCLI,0 QTVEN,0 AS VTVEN,0 AS VTDEV,'
      ...
      'AND      PK.FAPD = 1'
        ...
        'AND     (CAST(PK.DTNF AS DATE) BETWEEN (DATEADD(1 - EXTRACT(DAY ' +
        'FROM CURRENT_DATE) DAY TO CURRENT_DATE )) AND (DATEADD(-EXTRACT(' +
        'DAY FROM DATEADD(1 MONTH TO CURRENT_DATE )) DAY TO DATEADD(1 MON' +
        'TH TO CURRENT_DATE))))'
      'GROUP BY EMPRESA,PERIODO)'
    ...
    Left = 657
    Top = 56
    object QFBResumo_DiarioEMPRESA: TIBStringField
      DisplayLabel = 'Nome'
      FieldName = 'EMPRESA'
      ProviderFlags = []
      Size = 60
    end
    object QFBResumo_DiarioPERIODO: TDateField
      DisplayLabel = 'Data'
      FieldName = 'PERIODO'
      ProviderFlags = []
      DisplayFormat = 'dd/mm/yy'
    end
    object QFBResumo_DiarioPVCLI: TLargeintField
      DisplayLabel = 'Pedidos'
      FieldName = 'PVCLI'
      ProviderFlags = []
      DisplayFormat = '0'
    end
    object QFBResumo_DiarioNVCLI: TLargeintField
      DisplayLabel = 'Novos'
      FieldName = 'NVCLI'
      ProviderFlags = []
      DisplayFormat = '0'
    end
    object QFBResumo_DiarioQTVEN: TLargeintField
      DisplayLabel = 'Qtde.'
      FieldName = 'QTVEN'
      ProviderFlags = []
      DisplayFormat = '0'
    end
    object QFBResumo_DiarioVTVEN: TIBBCDField
      DisplayLabel = 'Total Pedidos'
      FieldName = 'VTVEN'
      ProviderFlags = []
      DisplayFormat = 'R$ ,##,0.00'
    ...
    object QFBResumo_DiarioVTDEV: TIBBCDField
      DisplayLabel = 'Dev. R$'
      FieldName = 'VTDEV'
      ProviderFlags = []
      DisplayFormat = ',##,0.00'
    ...
    object QFBResumo_DiarioVTFAT: TFloatField
      DisplayLabel = 'Total Faturado'
      FieldName = 'VTFAT'
      ProviderFlags = []
      DisplayFormat = 'R$ ,##,0.00'
  ...
  object QFBTAB_USER_ADM: TIBQuery
    ...
    SQL.Strings = (
      ...
      'WHERE    PK.IDLG = :LOG_ID'
      'ORDER BY PK.IDLG,PK.DESCRICAO,PK.REFERENCIA,PK.REGRA')
    Left = 296
    Top = 200
    ParamData = <
      item
