...
uses
  ...
  uPrincipal in 'uPrincipal.pas' {FrmSHE_B2B_OTM};
...
begin
  ...
  FrmSplash := TFrmSplash.Create(Nil);
    ...
    Application.CreateForm(TFrmSHE_B2B_OTM, FrmSHE_B2B_OTM);
  Application.Initialize;

    FreeAndNil(FrmSplash);

    Application.Run;
    FreeAndNil(FrmSHE_B2B_OTM);
  end;
end.
