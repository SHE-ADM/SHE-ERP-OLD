...
begin
  { Clear Matriz API }
  aPesquisa[9,00] := RecParametros.Id; { Empresa }
    ...
    begin
      ...
      begin
        try
          ...
          FrmSHE_API_BOL.Caption := 'OCX: ' + ANossaSituacao + ' - ' + IntToStr(PBCount) + ' de ' + IntToStr(PBPrincipal.Max) + '.';
          Application.ProcessMessages;
